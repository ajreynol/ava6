...
(declare-datatypes ((|__ava6_record_pos_(Set myType)_neg_(Set myType)| 0)) (((|__ava6_record_pos_(Set myType)_neg_(Set myType)_ctor| (pos (Set myType)) (neg (Set myType))))))



(declare-fun emptymyTypeSet () (Set myType))
(assert (= emptymyTypeSet (as set.empty (Set myType))))
(declare-fun d () (Array myType |__ava6_record_pos_(Set myType)_neg_(Set myType)|))
