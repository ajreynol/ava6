...
(declare-datatypes ((|__ava6_record_pos_(Set role)_neg_(Set role)| 0)) (((|__ava6_record_pos_(Set role)_neg_(Set role)_ctor| (pos (Set role)) (neg (Set role))))))


(declare-fun emptyRoleSet () (Set role))
(assert (= emptyRoleSet (as set.empty (Set role))))
(declare-fun d () (Array role |__ava6_record_pos_(Set role)_neg_(Set role)|))
