...
(declare-datatypes ((__ava6_record_i_Int 0)) (((__ava6_record_i_Int_ctor (i Int)))))


(declare-fun C_0 () (Array Int __ava6_record_i_Int))
(declare-fun x () Int)
(define-fun C_1 () (Array Int __ava6_record_i_Int) (store C_0 0 ((_ update i) (select C_0 0) 2)))
