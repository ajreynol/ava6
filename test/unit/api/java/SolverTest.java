...
import static io.github.ava6.RoundingMode.*;
import static io.github.ava6.SortKind.*;
import static org.junit.jupiter.api.Assertions.*;

import io.github.ava6.*;
import io.github.ava6.modes.BlockModelsMode;
import io.github.ava6.modes.FindSynthTarget;
import io.github.ava6.modes.LearnedLitType;
import io.github.ava6.modes.OptionCategory;
import io.github.ava6.modes.ProofComponent;
import io.github.ava6.modes.ProofFormat;
...
class SolverTest
{
  ...
  @Test
  void recoverableException() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_tm.mkConst(d_tm.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x).notTerm());
    assertThrows(AVA6ApiRecoverableException.class, () -> d_solver.getValue(x));
  }
  ...
  void declareDatatype()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.declareDatatype(("c"), ctors4));

    assertThrows(AVA6ApiException.class, () -> d_solver.declareDatatype((""), ctors4));

    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.declareDatatype(("a"), ctors1));
  }

  @Test
  void declareFun() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.declareFun("f2", new Sort[] {}, funSort));
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.declareFun("f1", new Sort[] {}, bvSort));
  }
  ...
  @Test
  void declareSortFresh() throws AVA6ApiException
  {
  ...
  @Test
  void defineFun() throws AVA6ApiException
  {
    Sort bvSort = d_solver.mkBitVectorSort(32);
    Sort funSort =
        d_solver.mkFunctionSort(d_solver.mkUninterpretedSort("u"), d_solver.getIntegerSort());
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFun("ff", new Term[] {v1, b2}, bvSort, v1));

    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFun("fff", new Term[] {b1}, bvSort, v2));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFun("ffff", new Term[] {b1}, funSort, v2));
    ...
    assertThrows(AVA6ApiException.class, () -> slv.defineFun("f", new Term[] {}, bvSort, v12));
    assertThrows(AVA6ApiException.class, () -> slv.defineFun("f", new Term[] {}, bvSort2, v1));
    assertThrows(
        AVA6ApiException.class, () -> slv.defineFun("ff", new Term[] {b1, b22}, bvSort2, v12));
    assertThrows(
        AVA6ApiException.class, () -> slv.defineFun("ff", new Term[] {b12, b2}, bvSort2, v12));
    assertThrows(
        AVA6ApiException.class, () -> slv.defineFun("ff", new Term[] {b12, b22}, bvSort, v12));
    assertThrows(
        AVA6ApiException.class, () -> slv.defineFun("ff", new Term[] {b12, b22}, bvSort2, v1));
  }
  ...
  @Test
  void defineFunRec() throws AVA6ApiException
  {
    Sort bvSort = d_solver.mkBitVectorSort(32);
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFunRec("fff", new Term[] {b1}, bvSort, v3));

    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFunRec("ff", new Term[] {b1, v2}, bvSort, v1));

    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFunRec("ffff", new Term[] {b1}, funSort2, v3));

    // b3 has function sort, which is allowed as an argument
    assertDoesNotThrow(() -> d_solver.defineFunRec("fffff", new Term[] {b1, b3}, bvSort, v1));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f1, new Term[] {b1}, v1));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f1, new Term[] {b1, b11}, v2));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f1, new Term[] {b1, b11}, v3));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f2, new Term[] {b1}, v2));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f3, new Term[] {b1}, v1));
    ...
    assertThrows(AVA6ApiException.class, () -> slv.defineFunRec("f", new Term[] {}, bvSort, v12));
    assertThrows(AVA6ApiException.class, () -> slv.defineFunRec("f", new Term[] {}, bvSort2, v1));
    assertThrows(
        AVA6ApiException.class, () -> slv.defineFunRec("ff", new Term[] {b1, b22}, bvSort2, v12));

    assertThrows(
        AVA6ApiException.class, () -> slv.defineFunRec("ff", new Term[] {b12, b2}, bvSort2, v12));

    assertThrows(
        AVA6ApiException.class, () -> slv.defineFunRec("ff", new Term[] {b12, b22}, bvSort, v12));

    assertThrows(
        AVA6ApiException.class, () -> slv.defineFunRec("ff", new Term[] {b12, b22}, bvSort2, v1));
  }

  @Test
  void defineFunRecWrongLogic() throws AVA6ApiException
  {
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_solver.defineFunRec("f", new Term[] {}, bvSort, v));
    assertThrows(AVA6ApiException.class, () -> d_solver.defineFunRec(f, new Term[] {b, b}, v));
  }

  @Test
  void defineFunRecGlobal() throws AVA6ApiException
  {
    Sort bSort = d_solver.getBooleanSort();
  ...
  @Test
  void defineFunsRec() throws AVA6ApiException
  {
  ...
  @Test
  void defineFunsRecWrongLogic() throws AVA6ApiException
  {
    d_solver.setLogic("QF_BV");
    Sort uSort = d_solver.mkUninterpretedSort("u");
    Sort bvSort = d_solver.mkBitVectorSort(32);
  ...
  @Test
  void defineFunsRecGlobal() throws AVA6ApiException
  {
    Sort bSort = d_solver.getBooleanSort();
    Sort fSort = d_solver.mkFunctionSort(bSort, bSort);
  ...
  void getInfo()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getInfo("asdf"));
  }

  @Test
  void getAbduct() throws AVA6ApiException
  {
  ...
  @Test
  void getAbduct2() throws AVA6ApiException
  {
    d_solver.setLogic("QF_LIA");
    d_solver.setOption("incremental", "false");
    Sort intSort = d_solver.getIntegerSort();
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getAbduct(conj));
  }

  @Test
  void getAbductNext() throws AVA6ApiException
  {
    d_solver.setLogic("QF_LIA");
    d_solver.setOption("produce-abducts", "true");
  ...
  @Test
  void getInterpolant() throws AVA6ApiException
  {
    d_solver.setLogic("QF_LIA");
  ...
  @Test
  void getInterpolantNext() throws AVA6ApiException
  {
    d_solver.setLogic("QF_LIA");
    d_solver.setOption("produce-interpolants", "true");
    d_solver.setOption("incremental", "true");
  ...
  @Test
  void declarePool() throws AVA6ApiException
  {
    Sort intSort = d_solver.getIntegerSort();
  ...
  void getOp() throws AVA6ApiException
  {
    ...
    assertFalse(a.hasOp());
    assertThrows(AVA6ApiException.class, () -> a.getOp());
  ...
  void getOption()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getOption("asdf"));
  }
  ...
  void getOptionInfo()
  {
    ...
    {
      assertions.add(
          () -> assertThrows(AVA6ApiException.class, () -> d_solver.getOptionInfo("asdf-invalid")));
    }
    {
  ...
  void getUnsatAssumptions1()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getUnsatAssumptions());
  }
  ...
  void getUnsatCore1()
  {
    ...
    d_solver.checkSat();
    assertThrows(AVA6ApiException.class, () -> d_solver.getUnsatCore());
  }
  ...
  void getUnsatCoreLemmas1()
  {
    d_solver.assertFormula(d_solver.mkFalse());
    assertTrue(d_solver.checkSat().isUnsat());
    assertThrows(AVA6ApiException.class, () -> d_solver.getUnsatCoreLemmas());
  }
  ...
  void getDifficulty()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getDifficulty());
    d_solver.checkSat();
  ...
  @Test
  void getDifficulty3() throws AVA6ApiException
  {
    d_solver.setOption("produce-difficulty", "true");
    Sort intSort = d_solver.getIntegerSort();
    Term x = d_solver.mkConst(intSort, "x");
  ...
  void getLearnedLiterals()
  {
    ...
    // cannot ask before a check sat
    assertThrows(AVA6ApiException.class, () -> d_solver.getLearnedLiterals());
    d_solver.checkSat();
  ...
  @Test
  void getTimeoutCoreUnsat() throws AVA6ApiException
  {
  ...
  @Test
  void getTimeoutCore() throws AVA6ApiException
  {
    d_solver.setOption("produce-unsat-cores", "true");
  ...
  @Test
  void getTimeoutCoreAssuming() throws AVA6ApiException
  {
    d_solver.setOption("produce-unsat-cores", "true");
    Term ff = d_solver.mkBoolean(false);
    Term tt = d_solver.mkBoolean(true);
  ...
  @Test
  void getTimeoutCoreAssumingEmpty() throws AVA6ApiException
  {
    d_solver.setOption("produce-unsat-cores", "true");
    assertThrows(AVA6ApiException.class, () -> d_solver.getTimeoutCoreAssuming(new Term[] {}));
  }
  ...
  void getValue1()
  {
    ...
    d_solver.assertFormula(t);
    d_solver.checkSat();
    assertThrows(AVA6ApiException.class, () -> d_solver.getValue(t));
  }
  ...
  void getValue3()
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.getValue(x));
  }
  ...
  void getModelDomainElements()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getModelDomainElements(intSort));
  }
  ...
  void isModelCoreSymbol()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.isModelCoreSymbol(zero));
  }
  ...
  void getModel()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getModel(sorts, terms2));
  }
  ...
  void getModel2()
  {
    ...
    Sort[] sorts = new Sort[] {};
    Term[] terms = new Term[] {};
    assertThrows(AVA6ApiException.class, () -> d_solver.getModel(sorts, terms));
  }
  ...
  void getModel3()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getModel(sorts2, terms));
  }
  ...
  void getQuantifierElimination()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getQuantifierElimination(new Term()));
    Solver slv = new Solver();
    assertThrows(
        AVA6ApiException.class, () -> d_solver.getQuantifierElimination(slv.mkBoolean(false)));
  ...
  void getQuantifierEliminationDisjunct()
  {
    ...
    Term forall = d_solver.mkTerm(
        FORALL, d_solver.mkTerm(VARIABLE_LIST, x), d_solver.mkTerm(OR, x, d_solver.mkTerm(NOT, x)));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.getQuantifierEliminationDisjunct(new Term()));
  ...
  @Test
  void declareSepHeap() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.declareSepHeap(integer, integer));
  }
  ...
  @Test
  void getValueSepHeap1() throws AVA6ApiException
  {
    d_solver.setLogic("QF_BV");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
    Term t = d_solver.mkTrue();
    d_solver.assertFormula(t);
    assertThrows(AVA6ApiException.class, () -> d_solver.getValueSepHeap());
  }

  @Test
  void getValueSepHeap2() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "false");
  ...
  @Test
  void getValueSepHeap3() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  @Test
  void getValueSepHeap4() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  @Test
  void getValueSepHeap5() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  @Test
  void getValueSepNil1() throws AVA6ApiException
  {
    d_solver.setLogic("QF_BV");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
    Term t = d_solver.mkTrue();
    d_solver.assertFormula(t);
    assertThrows(AVA6ApiException.class, () -> d_solver.getValueSepNil());
  }

  @Test
  void getValueSepNil2() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "false");
  ...
  @Test
  void getValueSepNil3() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  @Test
  void getValueSepNil4() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  @Test
  void getValueSepNil5() throws AVA6ApiException
  {
    d_solver.setLogic("ALL");
    d_solver.setOption("incremental", "false");
    d_solver.setOption("produce-models", "true");
  ...
  void push1()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.setOption("incremental", "false"));
    assertThrows(AVA6ApiException.class, () -> d_solver.setOption("incremental", "true"));
  }
  ...
  {
    d_solver.setOption("incremental", "false");
    assertThrows(AVA6ApiException.class, () -> d_solver.push(1));
  }
  ...
  {
    d_solver.setOption("incremental", "false");
    assertThrows(AVA6ApiException.class, () -> d_solver.pop(1));
  }
  ...
  void blockModel1()
  {
    ...
    d_solver.checkSat();
    assertThrows(AVA6ApiException.class, () -> d_solver.blockModel(BlockModelsMode.LITERALS));
  }

  @Test
  void blockModel2() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
  ...
  @Test
  void blockModel3() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
  ...
  @Test
  void blockModelValues1() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
    d_solver.checkSat();
    assertThrows(AVA6ApiException.class, () -> d_solver.blockModelValues(new Term[] {}));
    assertThrows(AVA6ApiException.class, () -> d_solver.blockModelValues(new Term[] {new Term()}));
    Solver slv = new Solver();
    assertThrows(
        AVA6ApiException.class, () -> d_solver.blockModelValues(new Term[] {slv.mkBoolean(false)}));
  }

  @Test
  void blockModelValues2() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
  ...
  @Test
  void blockModelValues3() throws AVA6ApiException
  {
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
    d_solver.checkSat();
    assertThrows(AVA6ApiException.class, () -> d_solver.blockModelValues(new Term[] {x}));
  }

  @Test
  void blockModelValues4() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
  ...
  @Test
  void blockModelValues5() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    Term x = d_solver.mkConst(d_solver.getBooleanSort(), "x");
    d_solver.assertFormula(x.eqTerm(x));
  ...
  @Test
  void getInstantiations() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getInstantiations());
    d_solver.checkSat();
    assertDoesNotThrow(() -> d_solver.getInstantiations());
  }

  @Test
  void setInfo() throws AVA6ApiException
  {
    assertThrows(AVA6ApiException.class, () -> d_solver.setInfo("cvc4-lagic", "QF_BV"));
    assertThrows(AVA6ApiException.class, () -> d_solver.setInfo("cvc2-logic", "QF_BV"));
    assertThrows(AVA6ApiException.class, () -> d_solver.setInfo("cvc4-logic", "asdf"));
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.setInfo("smt-lib-version", ".0"));
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.setInfo("status", "asdf"));
  }

  @Test
  void simplifyApplySubs() throws AVA6ApiException
  {
    d_solver.setOption("incremental", "true");
  ...
  @Test
  void simplify() throws AVA6ApiException
  {
    assertThrows(AVA6ApiException.class, () -> d_solver.simplify(new Term()));
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.simplify(x));
  ...
  void assertFormula()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.assertFormula(new Term()));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.assertFormula(d_solver.mkTrue()));
  }

  @Test
  void checkSat() throws AVA6ApiException
  {
    d_solver.setOption("incremental", "false");
    assertDoesNotThrow(() -> d_solver.checkSat());
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSat());
  }

  @Test
  void checkSatAssuming() throws AVA6ApiException
  {
    d_solver.setOption("incremental", "false");
    assertDoesNotThrow(() -> d_solver.checkSatAssuming(d_solver.mkTrue()));
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSatAssuming(d_solver.mkTrue()));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.checkSatAssuming(d_solver.mkTrue()));
  }

  @Test
  void checkSatAssuming1() throws AVA6ApiException
  {
    Sort boolSort = d_solver.getBooleanSort();
    ...
    d_solver.setOption("incremental", "true");
    assertDoesNotThrow(() -> d_solver.checkSatAssuming(d_solver.mkTrue()));
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSatAssuming(new Term()));
    assertDoesNotThrow(() -> d_solver.checkSatAssuming(d_solver.mkTrue()));
  ...
  @Test
  void checkSatAssuming2() throws AVA6ApiException
  {
    d_solver.setOption("incremental", "true");
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSatAssuming(n));
    assertThrows(AVA6ApiException.class,
  ...
  @Test
  void setLogic() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_solver.setLogic("AUFLIRA"));
    assertThrows(AVA6ApiException.class, () -> d_solver.setLogic("AF_BV"));
    d_solver.assertFormula(d_solver.mkTrue());
    assertThrows(AVA6ApiException.class, () -> d_solver.setLogic("AUFLIRA"));
  }

  @Test
  void isLogicSet() throws AVA6ApiException
  {
  ...
  @Test
  void getLogic() throws AVA6ApiException
  {
    assertThrows(AVA6ApiException.class, () -> d_solver.getLogic());
    assertDoesNotThrow(() -> d_solver.setLogic("QF_BV"));
    assertEquals(d_solver.getLogic(), "QF_BV");
  }

  @Test
  void setOption() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_solver.setOption("bv-sat-solver", "cadical"));
    assertThrows(AVA6ApiException.class, () -> d_solver.setOption("bv-sat-solver", "1"));
    d_solver.assertFormula(d_solver.mkTrue());
    assertThrows(AVA6ApiException.class, () -> d_solver.setOption("bv-sat-solver", "cadical"));
  }

  @Test
  void resetAssertions() throws AVA6ApiException
  {
    d_solver.setOption("incremental", "true");
  ...
  @Test
  void declareSygusVar() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.declareSygusVar("", new Sort()));
    assertThrows(AVA6ApiException.class, () -> d_solver.declareSygusVar("a", new Sort()));

    Solver slv = new Solver();
    slv.setOption("sygus", "true");
    assertThrows(AVA6ApiException.class, () -> slv.declareSygusVar("", boolSort));
  }

  @Test
  void mkGrammar() throws AVA6ApiException
  {
    Term nullTerm = new Term();
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.mkGrammar(new Term[] {}, new Term[] {}));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.mkGrammar(new Term[] {}, new Term[] {nullTerm}));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.mkGrammar(new Term[] {}, new Term[] {boolTerm}));
    assertThrows(AVA6ApiException.class,
    ...
    assertThrows(
        AVA6ApiException.class, () -> slv.mkGrammar(new Term[] {boolVar}, new Term[] {intVar2}));
    assertThrows(
        AVA6ApiException.class, () -> slv.mkGrammar(new Term[] {boolVar2}, new Term[] {intVar}));
  }

  @Test
  void synthFun() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_solver.synthFun("f3", new Term[] {nullTerm}, bool));
    assertThrows(AVA6ApiException.class, () -> d_solver.synthFun("f4", new Term[] {}, nullSort));
    assertThrows(AVA6ApiException.class, () -> d_solver.synthFun("f6", new Term[] {x}, bool, g2));
    ...
    assertThrows(
        AVA6ApiException.class, () -> slv.synthFun("", new Term[] {}, d_solver.getBooleanSort()));
    assertThrows(AVA6ApiException.class,
        () -> slv.synthFun("f1", new Term[] {x}, d_solver.getBooleanSort()));
  }

  @Test
  void addSygusConstraint() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    Term nullTerm = new Term();
    Term boolTerm = d_solver.mkBoolean(true);
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.addSygusConstraint(nullTerm));
    assertThrows(AVA6ApiException.class, () -> d_solver.addSygusConstraint(intTerm));

    Solver slv = new Solver();
    slv.setOption("sygus", "true");
    assertThrows(AVA6ApiException.class, () -> slv.addSygusConstraint(boolTerm));
  }
  ...
  void addSygusAssume()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.addSygusAssume(nullTerm));
    assertThrows(AVA6ApiException.class, () -> d_solver.addSygusAssume(intTerm));

    Solver slv = new Solver();
    slv.setOption("sygus", "true");
    assertThrows(AVA6ApiException.class, () -> slv.addSygusAssume(boolTerm));
  }
  ...
  @Test
  void addSygusInvConstraint() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    Sort bool = d_solver.getBooleanSort();
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(nullTerm, pre, trans, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, nullTerm, trans, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, nullTerm, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, trans, nullTerm));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(intTerm, pre, trans, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv1, pre, trans, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, trans, trans, post));
    assertThrows(AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, pre, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, trans1, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, trans2, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, trans3, post));
    assertThrows(
        AVA6ApiException.class, () -> d_solver.addSygusInvConstraint(inv, pre, trans, trans));
    ...
    assertThrows(
        AVA6ApiException.class, () -> slv.addSygusInvConstraint(inv, pre22, trans22, post22));
    assertThrows(
        AVA6ApiException.class, () -> slv.addSygusInvConstraint(inv22, pre, trans22, post22));
    assertThrows(
        AVA6ApiException.class, () -> slv.addSygusInvConstraint(inv22, pre22, trans, post22));
    assertThrows(
        AVA6ApiException.class, () -> slv.addSygusInvConstraint(inv22, pre22, trans22, post));
  }

  @Test
  void checkSynth() throws AVA6ApiException
  {
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSynth());
    d_solver.setOption("sygus", "true");
    assertDoesNotThrow(() -> d_solver.checkSynth());
  }

  @Test
  void getSynthSolution() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "false");
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolution(f));
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolution(nullTerm));
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolution(x));

    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.getSynthSolution(f));
  }

  @Test
  void getSynthSolutions() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "false");
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolutions(new Term[] {}));
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolutions(new Term[] {f}));
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolutions(new Term[] {}));
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolutions(new Term[] {nullTerm}));
    assertThrows(AVA6ApiException.class, () -> d_solver.getSynthSolutions(new Term[] {x}));

    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.getSynthSolutions(new Term[] {x}));
  }
  @Test
  void checkSynthNext() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "true");
    Term f = d_solver.synthFun("f", new Term[] {}, d_solver.getBooleanSort());
  ...
  @Test
  void checkSynthNext2() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "false");
    Term f = d_solver.synthFun("f", new Term[] {}, d_solver.getBooleanSort());
    ...
    d_solver.checkSynth();
    assertThrows(AVA6ApiException.class, () -> d_solver.checkSynthNext());
  }

  @Test
  void checkSynthNext3() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "true");
    Term f = d_solver.synthFun("f", new Term[] {}, d_solver.getBooleanSort());
  ...
  @Test
  void findSynth() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    Sort boolSort = d_solver.getBooleanSort();
  ...
  @Test
  void findSynth2() throws AVA6ApiException
  {
    d_solver.setOption("sygus", "true");
    d_solver.setOption("incremental", "true");
    Sort boolSort = d_solver.getBooleanSort();
  ...
  @Test
  void tupleProject() throws AVA6ApiException
  {
  ...
  @Test
  void declareOracleFunError() throws AVA6ApiException
  {
    Sort iSort = d_solver.getIntegerSort();
  ...
  @Test
  void declareOracleFunUnsat() throws AVA6ApiException
  {
    d_solver.setOption("oracles", "true");
    Sort iSort = d_solver.getIntegerSort();
  ...
  @Test
  void declareOracleFunSat() throws AVA6ApiException
  {
    d_solver.setOption("oracles", "true");
    d_solver.setOption("produce-models", "true");
    Sort iSort = d_solver.getIntegerSort();
  ...
  @Test
  void declareOracleFunSat2() throws AVA6ApiException
  {
    d_solver.setOption("oracles", "true");
    d_solver.setOption("produce-models", "true");
    Sort iSort = d_solver.getIntegerSort();
  ...
  @Test
  void getVersion() throws AVA6ApiException
  {
    System.out.println(d_solver.getVersion());
  }

  @Test
  void verticalBars() throws AVA6ApiException
  {
  ...
  @Test
  void multipleSolvers() throws AVA6ApiException
  {
