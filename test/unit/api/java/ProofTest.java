...
import static io.github.ava6.ProofRule.*;
...
class ProofTest
{
  ...
  Proof createProof() throws AVA6ApiException
  {
  ...
  Proof createRewriteProof() throws AVA6ApiException
  {
    d_solver.setOption("produce-proofs", "true");
  ...
  @Test
  void nullProof() throws AVA6ApiException
  {
  ...
  @Test
  void getRule() throws AVA6ApiException
  {
  ...
  @Test
  void getRewriteRule() throws AVA6ApiException
  {
    Proof proof = createRewriteProof();
    assertThrows(AVA6ApiException.class, () -> proof.getRewriteRule());
    ProofRule rule;
  ...
  @Test
  void getResult() throws AVA6ApiException
  {
    Proof proof = createProof();
  ...
  @Test
  void getChildren() throws AVA6ApiException
  {
    Proof proof = createProof();
  ...
  @Test
  void getArguments() throws AVA6ApiException
  {
    Proof proof = createProof();
  ...
  @Test
  void eq() throws AVA6ApiException
  {
    Proof x = createProof();
    Proof y = x.getChildren()[0];
    Proof z = new Proof();
