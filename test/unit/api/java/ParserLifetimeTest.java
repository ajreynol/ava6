...
class ParserLifetimeTest
{
  ...
  @Test
  void symbolManagerOutlivesTermManager() throws AVA6ApiException
  {
  ...
  @Test
  void declaredSymbolsOutliveParserAndManagers() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
  ...
  @Test
  void parsedTermOutlivesParserAndManagers() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
    Solver solver = new Solver(tm);
    SymbolManager sm = new SymbolManager(tm);
  ...
  @Test
  void parsedTermOutlivesParserWithInternalSymbolManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
    Solver solver = new Solver(tm);
