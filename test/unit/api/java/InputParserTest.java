...
class InputParserTest extends ParserTest
{
  ...
  {
    InputParser p = new InputParser(d_solver);
    assertThrows(AVA6ParserException.class,
  ...
  {
    InputParser p = new InputParser(d_solver);
    assertThrows(AVA6ApiException.class, () -> p.appendIncrementalStringInput("(set-logic ALL)"));
  }
  ...
  {
    InputParser p = new InputParser(d_solver);
    assertThrows(AVA6ApiException.class, () -> p.nextCommand());
    p.setIncrementalStringInput(InputLanguage.SMT_LIB_2_6, "input_parser_black");
  ...
  {
    InputParser p = new InputParser(d_solver);
    assertThrows(AVA6ApiException.class, () -> p.nextTerm());
    p.setIncrementalStringInput(InputLanguage.SMT_LIB_2_6, "input_parser_black");
    p.appendIncrementalStringInput("");
  ...
  void nextTerm2()
  {
    ...
    assertThrows(AVA6ParserException.class, () -> { Term t = p.nextTerm(); });
  }

  @Test
  void multipleParsers() throws AVA6ApiException
  {
    InputParser p = new InputParser(d_solver, d_symman);
    ...
    assertThrows(AVA6ApiException.class, () -> d_solver.setLogic("QF_LRA"));
    ...
    assertThrows(AVA6ParserException.class, () -> parseLogicCommand(p3, "QF_LRA"));
