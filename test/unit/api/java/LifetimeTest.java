...
class LifetimeTest
{
  ...
  @Test
  void termOutlivesTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
  ...
  @Test
  void opOutlivesTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
  ...
  @Test
  void datatypeOutlivesTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
  ...
  @Test
  void solverOutlivesTermManager() throws AVA6ApiException
  {
  ...
  @Test
  void valueOutlivesSolverAndTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
    Solver solver = new Solver(tm);
  ...
  @Test
  void grammarOutlivesSolverAndTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
    Solver solver = new Solver(tm);
  ...
  @Test
  void proofOutlivesSolverAndTermManager() throws AVA6ApiException
  {
    TermManager tm = new TermManager();
    Solver solver = new Solver(tm);
