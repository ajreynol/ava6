...
class DatatypeTest
{
  ...
  void mkDatatypeSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d.getConstructor(2));
  ...
  @Test
  void equalHash() throws AVA6ApiException
  {
  ...
  @Test
  void mkDatatypeSortsSelUnres() throws AVA6ApiException
  {
  ...
  @Test
  void datatypeStructs() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> cons.addSelector("null", nullSort));
    dtypeSpec.addConstructor(cons);
    DatatypeConstructorDecl nil = d_tm.mkDatatypeConstructorDecl("nil");
    dtypeSpec.addConstructor(nil);
  ...
  @Test
  void datatypeNames() throws AVA6ApiException
  {
    Sort intSort = d_tm.getIntegerSort();
    ...
    assertThrows(AVA6ApiException.class, () -> dt.getConstructor("head"));
    assertThrows(AVA6ApiException.class, () -> dt.getConstructor(""));

    DatatypeConstructor dcons = dt.getConstructor(0);
    assertEquals(dcons.getName(), "cons");
    assertDoesNotThrow(() -> dcons.getSelector("head"));
    assertDoesNotThrow(() -> dcons.getSelector("tail"));
    assertThrows(AVA6ApiException.class, () -> dcons.getSelector("cons"));
    ...
    assertThrows(AVA6ApiException.class, () -> new DatatypeDecl().getName());
  }

  @Test
  void parametricDatatype() throws AVA6ApiException
  {
  ...
  @Test
  void datatypeIsFinite() throws AVA6ApiException
  {
    List<Sort> v = new ArrayList<>();
    ...
    assertThrows(AVA6ApiException.class, () -> pdtype.getDatatype().isFinite());
  }

  @Test
  void datatypeSimplyRec() throws AVA6ApiException
  {
  ...
  @Test
  void datatypeSpecializedCons() throws AVA6ApiException
  {
    /* Create mutual datatypes corresponding to this definition block:
     *   DATATYPE
    ...
    assertThrows(AVA6ApiException.class, () -> nilc.getInstantiatedTerm(isort));
  }
}
