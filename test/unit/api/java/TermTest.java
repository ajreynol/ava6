...
package tests;
import static io.github.ava6.Kind.*;
import static org.junit.jupiter.api.Assertions.*;

import io.github.ava6.*;
...
class TermTest
{
  ...
  {
    Term n = new Term();
    assertThrows(AVA6ApiException.class, () -> n.getId());
  ...
  @Test
  void getKind() throws AVA6ApiException
  {
    Sort uSort = d_tm.mkUninterpretedSort("u");
    ...
    Term n = new Term();
    assertThrows(AVA6ApiException.class, () -> n.getKind());
    Term x = d_tm.mkVar(uSort, "x");
  ...
  @Test
  void getSort() throws AVA6ApiException
  {
    ...
    Term n = new Term();
    assertThrows(AVA6ApiException.class, () -> n.getSort());
  ...
  @Test
  void getOp() throws AVA6ApiException
  {
    Sort intsort = d_tm.getIntegerSort();
    Sort bvsort = d_tm.mkBitVectorSort(8);
    ...
    assertFalse(x.hasOp());
    assertThrows(AVA6ApiException.class, () -> x.getOp());
    ...
    assertFalse(f.hasOp());
    assertThrows(AVA6ApiException.class, () -> f.getOp());
    assertTrue(fx.hasOp());
  ...
  @Test
  void hasGetSymbol() throws AVA6ApiException
  {
    Term n = new Term();
    Term t = d_tm.mkBoolean(true);
    Term c = d_tm.mkConst(d_tm.getBooleanSort(), "|\\|");

    assertThrows(AVA6ApiException.class, () -> n.hasSymbol());
    assertFalse(t.hasSymbol());
    assertTrue(c.hasSymbol());

    assertThrows(AVA6ApiException.class, () -> n.getSymbol());
    assertThrows(AVA6ApiException.class, () -> t.getSymbol());
    assertEquals(c.getSymbol(), "|\\|");
  }

  @Test
  void isNull() throws AVA6ApiException
  {
    Term x = new Term();
    assertTrue(x.isNull());
  ...
  @Test
  void notTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    assertThrows(AVA6ApiException.class, () -> new Term().notTerm());
    Term b = d_tm.mkTrue();
    assertDoesNotThrow(() -> b.notTerm());
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.notTerm());
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.notTerm());
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.notTerm());
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.notTerm());
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.notTerm());
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.notTerm());
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
  ...
  @Test
  void andTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().andTerm(b));
    assertThrows(AVA6ApiException.class, () -> b.andTerm(new Term()));
    assertDoesNotThrow(() -> b.andTerm(b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> x.andTerm(x));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> f.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> f.andTerm(f));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> p.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> p.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> p.andTerm(p));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> zero.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> zero.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> zero.andTerm(p));
    assertThrows(AVA6ApiException.class, () -> zero.andTerm(zero));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(p));
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(zero));
    assertThrows(AVA6ApiException.class, () -> f_x.andTerm(f_x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(p));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(zero));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> sum.andTerm(sum));
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
    assertDoesNotThrow(() -> p_0.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_0.andTerm(sum));
    assertDoesNotThrow(() -> p_0.andTerm(p_0));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.andTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.andTerm(sum));
    assertDoesNotThrow(() -> p_f_x.andTerm(p_0));
    assertDoesNotThrow(() -> p_f_x.andTerm(p_f_x));
  }

  @Test
  void orTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().orTerm(b));
    assertThrows(AVA6ApiException.class, () -> b.orTerm(new Term()));
    assertDoesNotThrow(() -> b.orTerm(b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> x.orTerm(x));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> f.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> f.orTerm(f));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> p.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> p.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> p.orTerm(p));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> zero.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> zero.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> zero.orTerm(p));
    assertThrows(AVA6ApiException.class, () -> zero.orTerm(zero));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(p));
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(zero));
    assertThrows(AVA6ApiException.class, () -> f_x.orTerm(f_x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(p));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(zero));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> sum.orTerm(sum));
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
    assertDoesNotThrow(() -> p_0.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_0.orTerm(sum));
    assertDoesNotThrow(() -> p_0.orTerm(p_0));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.orTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.orTerm(sum));
    assertDoesNotThrow(() -> p_f_x.orTerm(p_0));
    assertDoesNotThrow(() -> p_f_x.orTerm(p_f_x));
  }

  @Test
  void xorTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> b.xorTerm(new Term()));
    assertDoesNotThrow(() -> b.xorTerm(b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> x.xorTerm(x));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> f.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> f.xorTerm(f));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> p.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> p.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> p.xorTerm(p));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> zero.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> zero.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> zero.xorTerm(p));
    assertThrows(AVA6ApiException.class, () -> zero.xorTerm(zero));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(p));
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(zero));
    assertThrows(AVA6ApiException.class, () -> f_x.xorTerm(f_x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(p));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(zero));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> sum.xorTerm(sum));
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
    assertDoesNotThrow(() -> p_0.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_0.xorTerm(sum));
    assertDoesNotThrow(() -> p_0.xorTerm(p_0));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.xorTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.xorTerm(sum));
    assertDoesNotThrow(() -> p_f_x.xorTerm(p_0));
    assertDoesNotThrow(() -> p_f_x.xorTerm(p_f_x));
  }

  @Test
  void eqTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> b.eqTerm(new Term()));
    assertDoesNotThrow(() -> b.eqTerm(b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.eqTerm(b));
    assertDoesNotThrow(() -> x.eqTerm(x));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> f.eqTerm(x));
    assertDoesNotThrow(() -> f.eqTerm(f));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> p.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> p.eqTerm(f));
    assertDoesNotThrow(() -> p.eqTerm(p));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> zero.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> zero.eqTerm(f));
    assertThrows(AVA6ApiException.class, () -> zero.eqTerm(p));
    assertDoesNotThrow(() -> zero.eqTerm(zero));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> f_x.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> f_x.eqTerm(f));
    assertThrows(AVA6ApiException.class, () -> f_x.eqTerm(p));
    assertDoesNotThrow(() -> f_x.eqTerm(zero));
    assertDoesNotThrow(() -> f_x.eqTerm(f_x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> sum.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> sum.eqTerm(f));
    assertThrows(AVA6ApiException.class, () -> sum.eqTerm(p));
    ...
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_0.eqTerm(sum));
    assertDoesNotThrow(() -> p_0.eqTerm(p_0));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.eqTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.eqTerm(sum));
    assertDoesNotThrow(() -> p_f_x.eqTerm(p_0));
    assertDoesNotThrow(() -> p_f_x.eqTerm(p_f_x));
  }

  @Test
  void impTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().impTerm(b));
    assertThrows(AVA6ApiException.class, () -> b.impTerm(new Term()));
    assertDoesNotThrow(() -> b.impTerm(b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertThrows(AVA6ApiException.class, () -> x.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> x.impTerm(x));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> f.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> f.impTerm(f));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> p.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> p.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> p.impTerm(p));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> zero.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> zero.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> zero.impTerm(p));
    assertThrows(AVA6ApiException.class, () -> zero.impTerm(zero));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(p));
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(zero));
    assertThrows(AVA6ApiException.class, () -> f_x.impTerm(f_x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(p));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(zero));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> sum.impTerm(sum));
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
    assertDoesNotThrow(() -> p_0.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_0.impTerm(sum));
    assertDoesNotThrow(() -> p_0.impTerm(p_0));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.impTerm(b));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(f));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(p));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(zero));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(f_x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.impTerm(sum));
    assertDoesNotThrow(() -> p_f_x.impTerm(p_0));
    assertDoesNotThrow(() -> p_f_x.impTerm(p_f_x));
  }

  @Test
  void iteTerm() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(8);
    Sort intSort = d_tm.getIntegerSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    Term b = d_tm.mkTrue();
    assertThrows(AVA6ApiException.class, () -> new Term().iteTerm(b, b));
    assertThrows(AVA6ApiException.class, () -> b.iteTerm(new Term(), b));
    assertThrows(AVA6ApiException.class, () -> b.iteTerm(b, new Term()));
    assertDoesNotThrow(() -> b.iteTerm(b, b));
    Term x = d_tm.mkVar(d_tm.mkBitVectorSort(8), "x");
    assertDoesNotThrow(() -> b.iteTerm(x, x));
    assertDoesNotThrow(() -> b.iteTerm(b, b));
    assertThrows(AVA6ApiException.class, () -> b.iteTerm(x, b));
    assertThrows(AVA6ApiException.class, () -> x.iteTerm(x, x));
    assertThrows(AVA6ApiException.class, () -> x.iteTerm(x, b));
    Term f = d_tm.mkVar(funSort1, "f");
    assertThrows(AVA6ApiException.class, () -> f.iteTerm(b, b));
    assertThrows(AVA6ApiException.class, () -> x.iteTerm(b, x));
    Term p = d_tm.mkVar(funSort2, "p");
    assertThrows(AVA6ApiException.class, () -> p.iteTerm(b, b));
    assertThrows(AVA6ApiException.class, () -> p.iteTerm(x, b));
    Term zero = d_tm.mkInteger(0);
    assertThrows(AVA6ApiException.class, () -> zero.iteTerm(x, x));
    assertThrows(AVA6ApiException.class, () -> zero.iteTerm(x, b));
    Term f_x = d_tm.mkTerm(APPLY_UF, f, x);
    assertThrows(AVA6ApiException.class, () -> f_x.iteTerm(b, b));
    assertThrows(AVA6ApiException.class, () -> f_x.iteTerm(b, x));
    Term sum = d_tm.mkTerm(ADD, f_x, f_x);
    assertThrows(AVA6ApiException.class, () -> sum.iteTerm(x, x));
    assertThrows(AVA6ApiException.class, () -> sum.iteTerm(b, x));
    Term p_0 = d_tm.mkTerm(APPLY_UF, p, zero);
    assertDoesNotThrow(() -> p_0.iteTerm(b, b));
    assertDoesNotThrow(() -> p_0.iteTerm(x, x));
    assertThrows(AVA6ApiException.class, () -> p_0.iteTerm(x, b));
    Term p_f_x = d_tm.mkTerm(APPLY_UF, p, f_x);
    assertDoesNotThrow(() -> p_f_x.iteTerm(b, b));
    assertDoesNotThrow(() -> p_f_x.iteTerm(x, x));
    assertThrows(AVA6ApiException.class, () -> p_f_x.iteTerm(x, b));
  }
  ...
  @Test
  void termChildren() throws AVA6ApiException
  {
    // simple term 2+3
    ...
    Term tnull = new Term();
    assertThrows(AVA6ApiException.class, () -> tnull.getNumChildren());
    ...
    assertThrows(AVA6ApiException.class, () -> tnull.getChild(0));
  }

  @Test
  void getIntegerValue() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger(""));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("-"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("-1-"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("0.0"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("-0.1"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("012"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("0000"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("-01"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("-00"));
  ...
  @Test
  void getReal() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("1/0"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("2/0000"));
  }
  ...
  void getConstArrayBase()
  {
    ...
    Term a = d_tm.mkConst(arrsort, "a");
    assertThrows(AVA6ApiException.class, () -> a.getConstArrayBase());
    assertThrows(AVA6ApiException.class, () -> one.getConstArrayBase());
  }
  ...
  @Test
  void getBitVector() throws AVA6ApiException
  {
  ...
  @Test
  void getUninterpretedSortValue() throws AVA6ApiException
  {
  ...
  @Test
  void isRoundingModeValue() throws AVA6ApiException
  {
  ...
  @Test
  void getRoundingModeValue() throws AVA6ApiException
  {
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger(15).getRoundingModeValue());
    assertEquals(
  ...
  @Test
  void getFloatingPoint() throws AVA6ApiException
  {
  ...
  @Test
  void getCardinalityConstraint() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> x.getCardinalityConstraint());
    Term nullt = new Term();
    assertThrows(AVA6ApiException.class, () -> nullt.isCardinalityConstraint());
  }

  @Test
  void getRealAlgebraicNumber() throws AVA6ApiException
  {
    d_solver.setOption("produce-models", "true");
    ...
    if (d_solver.checkSat().isSat())
    {
      ...
      assertThrows(AVA6ApiException.class, () -> vx.getRealAlgebraicNumberDefiningPolynomial(yc));
    }
  }

  @Test
  void getSkolem() throws AVA6ApiException
  {
    // ordinary variables are not skolems
    Term x = d_solver.mkConst(d_solver.getIntegerSort(), "x");
    assertFalse(x.isSkolem());
    assertThrows(AVA6ApiException.class, () -> x.getSkolemId());
    assertThrows(AVA6ApiException.class, () -> x.getSkolemIndices());
  }

  @Test
  void testMkSkolem() throws AVA6ApiException
  {
  ...
  @Test
  void testGetNumIndices() throws AVA6ApiException
  {
  ...
  void substitute()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> xpx.substitute(one, ttrue));
    ...
    rs.remove(rs.size() - 1);
    assertThrows(AVA6ApiException.class,
    ...
    Term tnull = new Term();
    assertThrows(AVA6ApiException.class, () -> tnull.substitute(one, x));
    assertThrows(AVA6ApiException.class, () -> xpx.substitute(tnull, x));
    assertThrows(AVA6ApiException.class, () -> xpx.substitute(x, tnull));
    rs.remove(rs.size() - 1);
    rs.add(tnull);
    assertThrows(AVA6ApiException.class,
        () -> xpy.substitute(es.toArray(new Term[0]), rs.toArray(new Term[0])));
  ...
  @Test
  void constArray() throws AVA6ApiException
  {
    Sort intsort = d_tm.getIntegerSort();
    Sort arrsort = d_tm.mkArraySort(intsort, intsort);
    Term a = d_tm.mkConst(arrsort, "a");
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(arrsort, two));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(arrsort, iconst));
  ...
  @Test
  void getSequenceValue() throws AVA6ApiException
  {
    Sort realsort = d_tm.getRealSort();
    ...
    assertThrows(AVA6ApiException.class, () -> su.getSequenceValue());
  }
