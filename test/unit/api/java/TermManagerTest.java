...
class TermManagerTest
{
  ...
  @Test
  void getBooleanSort() throws AVA6ApiException
  {
  ...
  @Test
  void getRealSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.getRealSort());
  }

  @Test
  void getRegExpSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.getRegExpSort());
  }

  @Test
  void getStringSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.getStringSort());
  }

  @Test
  void getRoundingModeSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.getRoundingModeSort());
  }

  @Test
  void mkArraySort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> slv.mkArraySort(boolSort, boolSort));
  }

  @Test
  void mkBitVectorSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.mkBitVectorSort(32));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVectorSort(0));
  }

  @Test
  void mkFloatingPointSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.mkFloatingPointSort(4, 8));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPointSort(0, 8));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPointSort(4, 0));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPointSort(1, 8));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPointSort(4, 1));
  }

  @Test
  void mkDatatypeSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkDatatypeSort(dtypeSpec));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkDatatypeSort(dtypeSpec));

    DatatypeDecl throwsDtypeSpec = d_tm.mkDatatypeDecl("list");
    assertThrows(AVA6ApiException.class, () -> d_tm.mkDatatypeSort(throwsDtypeSpec));
  }

  @Test
  void mkDatatypeSorts() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkDatatypeSorts(decls));
    assertThrows(AVA6ApiException.class, () -> d_solver.mkDatatypeSorts(decls));

    DatatypeDecl throwsDtypeSpec = d_tm.mkDatatypeDecl("list");
    DatatypeDecl[] throwsDecls = new DatatypeDecl[] {throwsDtypeSpec};
    assertThrows(AVA6ApiException.class, () -> d_tm.mkDatatypeSorts(throwsDecls));
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkDatatypeSorts(udecls));
    assertThrows(AVA6ApiException.class, () -> d_solver.mkDatatypeSorts(udecls));
  ...
  @Test
  void mkFunctionSort() throws AVA6ApiException
  {
    assertDoesNotThrow(
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFunctionSort(d_tm.getIntegerSort(), funSort));
    ...
    assertThrows(
        AVA6ApiException.class, () -> slv.mkFunctionSort(sorts2, d_solver.getIntegerSort()));
    assertThrows(
        AVA6ApiException.class, () -> slv.mkFunctionSort(sorts1, d_solver.getIntegerSort()));
    assertThrows(AVA6ApiException.class, () -> slv.mkFunctionSort(sorts2, d_tm.getIntegerSort()));
  }

  @Test
  void mkParamSort() throws AVA6ApiException
  {
  ...
  void mkPredicateSort()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkPredicateSort(new Sort[] {}));
    Sort funSort = d_tm.mkFunctionSort(d_tm.mkUninterpretedSort("u"), d_tm.getIntegerSort());
    ...
    Solver slv = new Solver();
    assertThrows(
        AVA6ApiException.class, () -> slv.mkPredicateSort(new Sort[] {d_tm.getIntegerSort()}));
  }

  @Test
  void mkRecordSort() throws AVA6ApiException
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkRecordSort(fields));
  }

  @Test
  void mkSetSort() throws AVA6ApiException
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkSetSort(d_tm.mkBitVectorSort(4)));
  }

  @Test
  void mkBagSort() throws AVA6ApiException
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkBagSort(d_tm.mkBitVectorSort(4)));
  }

  @Test
  void mkSequenceSort() throws AVA6ApiException
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkSequenceSort(d_tm.getIntegerSort()));
  }

  @Test
  void mkAbstractSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkAbstractSort(BOOLEAN_SORT));
  }

  @Test
  void mkUninterpretedSort() throws AVA6ApiException
  {
  ...
  @Test
  void mkUnresolvedDatatypeSort() throws AVA6ApiException
  {
  ...
  @Test
  void mkUninterpretedSortConstructorSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkUninterpretedSortConstructorSort(0));
  }

  @Test
  void mkTupleSort() throws AVA6ApiException
  {
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkTupleSort(new Sort[] {d_tm.getIntegerSort()}));
  }

  @Test
  void mkNullableSort() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.mkNullableSort(d_tm.getIntegerSort()));

    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkNullableSort(d_tm.getIntegerSort()));
  }

  @Test
  void mkBitVector() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(0, 2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(0, "-127", 10));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(0, "a0", 16));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "", 2));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "101", 5));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "128", 11));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "a0", 21));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "-11111111", 2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "101010101", 2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "-256", 10));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "257", 10));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "-a0", 16));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "fffff", 16));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "10201010", 2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "-25x", 10));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "2x7", 10));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkBitVector(8, "fzff", 16));
  ...
  @Test
  void mkVar() throws AVA6ApiException
  {
    Sort boolSort = d_tm.getBooleanSort();
    Sort intSort = d_tm.getIntegerSort();
    ...
    assertDoesNotThrow(() -> d_tm.mkVar(funSort, ""));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkVar(new Sort()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkVar(new Sort(), "a"));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkVar(boolSort, "x"));
  }

  @Test
  void mkBoolean() throws AVA6ApiException
  {
  ...
  @Test
  void mkRoundingMode() throws AVA6ApiException
  {
  ...
  @Test
  void mkFloatingPoint() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPoint(0, 5, new Term()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPoint(0, 5, t1));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPoint(3, 0, t1));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPoint(3, 5, t2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkFloatingPoint(3, 5, t2));
    ...
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkFloatingPoint(3, 5, t1));
  }

  @Test
  void mkCardinalityConstraint() throws AVA6ApiException
  {
    Sort su = d_tm.mkUninterpretedSort("u");
    Sort si = d_tm.getIntegerSort();
    assertDoesNotThrow(() -> d_tm.mkCardinalityConstraint(su, 3));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkCardinalityConstraint(si, 3));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkCardinalityConstraint(su, 0));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkCardinalityConstraint(su, 3));
  }

  @Test
  void mkEmptySet() throws AVA6ApiException
  {
    Sort s = d_tm.mkSetSort(d_tm.getBooleanSort());
    assertThrows(AVA6ApiException.class, () -> d_tm.mkEmptySet(new Sort()));
    assertDoesNotThrow(() -> d_tm.mkEmptySet(s));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkEmptySet(d_tm.getBooleanSort()));
    assertDoesNotThrow(() -> d_solver.mkEmptySet(s));
  }

  @Test
  void mkEmptyBag() throws AVA6ApiException
  {
    Sort s = d_tm.mkBagSort(d_tm.getBooleanSort());
    assertThrows(AVA6ApiException.class, () -> d_tm.mkEmptyBag(new Sort()));
    assertDoesNotThrow(() -> d_tm.mkEmptyBag(s));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkEmptyBag(d_tm.getBooleanSort()));

    assertDoesNotThrow(() -> d_solver.mkEmptyBag(s));
  }

  @Test
  void mkEmptySequence() throws AVA6ApiException
  {
  ...
  @Test
  void mkFalse() throws AVA6ApiException
  {
  ...
  @Test
  void mkFloatingPointNaN() throws AVA6ApiException
  {
    assertDoesNotThrow(() -> d_tm.mkFloatingPointNaN(3, 5));
  }

  @Test
  void mkFloatingPointNegZero() throws AVA6ApiException
  {
  ...
  void mkOp()
  {
    ...
    // assertThrows(AVA6ApiException.class, () -> d_tm.mkOp(BITVECTOR_EXTRACT, EQUAL));

    // mkOp(Kind kind, const std::string& arg)
    assertDoesNotThrow(() -> d_tm.mkOp(DIVISIBLE, "2147483648"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkOp(BITVECTOR_EXTRACT, "asdf"));
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkOp(BITVECTOR_EXTRACT, 1));

    // mkOp(Kind kind, int arg1, int arg2)
    assertDoesNotThrow(() -> d_tm.mkOp(BITVECTOR_EXTRACT, 1, 1));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkOp(DIVISIBLE, 1, 2));
  ...
  void mkInteger()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("1.23"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("1/23"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("12/3"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger(".2"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("2."));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger(""));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("asdf"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("1.2/3"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("."));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("/"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("2/"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkInteger("/2"));
  ...
  void mkReal()
  {
    ...
    assertDoesNotThrow(() -> d_tm.mkReal("2."));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal(""));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("asdf"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("1.2/3"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("."));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("/"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("2/"));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkReal("/2"));
  ...
  void mkSepNil()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkSepNil(new Sort()));
    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkSepNil(d_tm.getIntegerSort()));
  }
  ...
  @Test
  void mkTerm() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(CONST_BITVECTOR));

    // mkTerm(Kind kind, Term child) const
    assertDoesNotThrow(() -> d_tm.mkTerm(NOT, d_tm.mkTrue()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(NOT, new Term()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(NOT, a));
    assertDoesNotThrow(() -> d_solver.mkTerm(NOT, d_tm.mkTrue()));

    // mkTerm(Kind kind, Term child1, Term child2) const
    assertDoesNotThrow(() -> d_tm.mkTerm(EQUAL, a, b));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(EQUAL, new Term(), b));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(EQUAL, a, new Term()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(EQUAL, a, d_tm.mkTrue()));
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkTerm(ITE, new Term(), d_tm.mkTrue(), d_tm.mkTrue()));

    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkTerm(ITE, d_tm.mkTrue(), new Term(), d_tm.mkTrue()));

    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkTerm(ITE, d_tm.mkTrue(), d_tm.mkTrue(), new Term()));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(ITE, d_tm.mkTrue(), d_tm.mkTrue(), b));
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(EQUAL, v2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(EQUAL, v3));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(DISTINCT, v6));
  }

  @Test
  void mkTermFromOp() throws AVA6ApiException
  {
    Sort bv32 = d_tm.mkBitVectorSort(32);
    Term a = d_tm.mkConst(bv32, "a");
    Term b = d_tm.mkConst(bv32, "b");
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(APPLY_SELECTOR, nilTerm));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(APPLY_SELECTOR, consTerm));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(APPLY_CONSTRUCTOR, consTerm));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm1));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(APPLY_SELECTOR, headTerm));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm1));
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, a));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm1, new Term()));
    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkTerm(APPLY_CONSTRUCTOR, consTerm, d_tm.mkInteger(0)));
    ...
    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, d_tm.mkInteger(1), d_tm.mkInteger(2)));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm1, a, b));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, d_tm.mkInteger(1), new Term()));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, new Term(), d_tm.mkInteger(1)));
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm1, a, b, a));
    assertThrows(AVA6ApiException.class,
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, v1));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, v2));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkTerm(opterm2, v3));
  ...
  void mkTuple()
  {
    ...
    Solver slv = new Solver();
    assertThrows(
        AVA6ApiException.class, () -> slv.mkTuple(new Term[] {d_solver.mkBitVector(3, "101", 2)}));

    assertThrows(
        AVA6ApiException.class, () -> slv.mkTuple(new Term[] {d_tm.mkBitVector(3, "101", 2)}));
  }
  ...
  void mkNullableSome()
  {
    ...
    Solver slv = new Solver();
    assertThrows(
        AVA6ApiException.class, () -> slv.mkNullableSome(d_solver.mkBitVector(3, "101", 2)));

    assertThrows(AVA6ApiException.class, () -> slv.mkNullableSome(d_tm.mkBitVector(3, "101", 2)));
  }
  ...
  void mkUniverseSet()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkUniverseSet(new Sort()));
  ...
  void mkConst()
  {
    ...
    assertDoesNotThrow(() -> d_tm.mkConst(funSort, ""));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConst(new Sort()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConst(new Sort(), "a"));

    Solver slv = new Solver();
    assertThrows(AVA6ApiException.class, () -> slv.mkConst(boolSort));
  }
  ...
  void mkConstArray()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(new Sort(), zero));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(arrSort, new Term()));
    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(arrSort, d_tm.mkBitVector(1, 1)));

    assertThrows(AVA6ApiException.class, () -> d_tm.mkConstArray(intSort, zero));
    Solver slv = new Solver();
    Term zero2 = slv.mkInteger(0);
    Sort arrSort2 = slv.mkArraySort(slv.getIntegerSort(), slv.getIntegerSort());
    assertThrows(AVA6ApiException.class, () -> slv.mkConstArray(arrSort2, zero));
    assertThrows(AVA6ApiException.class, () -> slv.mkConstArray(arrSort, zero2));
  }
  ...
  void getStatistics()
  {
    ...
    for (Statistics.ConstIterator it = stats.iterator(true, true); it.hasNext();)
    {
      ...
      if (elem.getKey().equals("ava6::CONSTANT"))
      {
