...
class GrammarTest
{
  ...
  void addRule()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> g.addRule(nullTerm, d_tm.mkBoolean(false)));
    assertThrows(AVA6ApiException.class, () -> g.addRule(start, nullTerm));
    assertThrows(AVA6ApiException.class, () -> g.addRule(nts, d_tm.mkBoolean(false)));
    assertThrows(AVA6ApiException.class, () -> g.addRule(start, d_tm.mkInteger(0)));

    d_solver.synthFun("f", new Term[] {}, bool, g);

    assertThrows(AVA6ApiException.class, () -> g.addRule(start, d_tm.mkBoolean(false)));
  }
  ...
  void addRules()
  {
    ...
    assertThrows(
        AVA6ApiException.class, () -> g.addRules(nullTerm, new Term[] {d_tm.mkBoolean(false)}));
    assertThrows(AVA6ApiException.class, () -> g.addRules(start, new Term[] {nullTerm}));
    assertThrows(AVA6ApiException.class, () -> g.addRules(nts, new Term[] {d_tm.mkBoolean(false)}));
    assertThrows(AVA6ApiException.class, () -> g.addRules(start, new Term[] {d_tm.mkInteger(0)}));

    d_solver.synthFun("f", new Term[] {}, bool, g);

    assertThrows(
        AVA6ApiException.class, () -> g.addRules(start, new Term[] {d_tm.mkBoolean(false)}));
  }
  ...
  void addAnyConstant()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> g.addAnyConstant(nullTerm));
    assertThrows(AVA6ApiException.class, () -> g.addAnyConstant(nts));

    d_solver.synthFun("f", new Term[] {}, bool, g);

    assertThrows(AVA6ApiException.class, () -> g.addAnyConstant(start));
  }
  ...
  void addAnyVariable()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> g1.addAnyVariable(nullTerm));
    assertThrows(AVA6ApiException.class, () -> g1.addAnyVariable(nts));

    d_solver.synthFun("f", new Term[] {}, bool, g1);

    assertThrows(AVA6ApiException.class, () -> g1.addAnyVariable(start));
  }
