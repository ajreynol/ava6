...
class SortTest
{
  ...
  Sort create_datatype_sort() throws AVA6ApiException
  {
  ...
  Sort create_param_datatype_sort() throws AVA6ApiException
  {
  ...
  void hasGetSymbol() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> b.getSymbol());
  ...
  @Test
  void isRoundingMode() throws AVA6ApiException
  {
  ...
  @Test
  void isBitVector() throws AVA6ApiException
  {
  ...
  @Test
  void isFloatingPoint() throws AVA6ApiException
  {
  ...
  @Test
  void isDatatype() throws AVA6ApiException
  {
    Sort dt_sort = create_datatype_sort();
  ...
  @Test
  void isDatatypeConstructor() throws AVA6ApiException
  {
    Sort dt_sort = create_datatype_sort();
  ...
  @Test
  void isDatatypeSelector() throws AVA6ApiException
  {
    Sort dt_sort = create_datatype_sort();
    Datatype dt = dt_sort.getDatatype();
  ...
  @Test
  void isDatatypeTester() throws AVA6ApiException
  {
    Sort dt_sort = create_datatype_sort();
    Datatype dt = dt_sort.getDatatype();
  ...
  @Test
  void isDatatypeUpdater() throws AVA6ApiException
  {
    Sort dt_sort = create_datatype_sort();
    Datatype dt = dt_sort.getDatatype();
  ...
  @Test
  void isUninterpretedSortSortConstructor() throws AVA6ApiException
  {
  ...
  @Test
  void getDatatype() throws AVA6ApiException
  {
    Sort dtypeSort = create_datatype_sort();
    assertDoesNotThrow(() -> dtypeSort.getDatatype());
    // create bv sort, check should fail
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getDatatype());
  }

  @Test
  void datatypeSorts() throws AVA6ApiException
  {
    Sort intSort = d_tm.getIntegerSort();
    Sort dtypeSort = create_datatype_sort();
    Datatype dt = dtypeSort.getDatatype();
    assertFalse(dtypeSort.isDatatypeConstructor());
    assertThrows(AVA6ApiException.class, () -> dtypeSort.getDatatypeConstructorCodomainSort());
    assertThrows(AVA6ApiException.class, () -> dtypeSort.getDatatypeConstructorDomainSorts());
    assertThrows(AVA6ApiException.class, () -> dtypeSort.getDatatypeConstructorArity());
    ...
    assertThrows(AVA6ApiException.class, () -> booleanSort.getDatatypeTesterDomainSort());
    assertThrows(AVA6ApiException.class, () -> booleanSort.getDatatypeTesterCodomainSort());
    ...
    assertThrows(AVA6ApiException.class, () -> booleanSort.getDatatypeSelectorDomainSort());
    assertThrows(AVA6ApiException.class, () -> booleanSort.getDatatypeSelectorCodomainSort());
  }

  @Test
  void instantiate() throws AVA6ApiException
  {
    ...
    assertThrows(
        AVA6ApiException.class, () -> dtypeSort.instantiate(new Sort[] {d_tm.getIntegerSort()}));
  ...
  @Test
  void isInstantiated() throws AVA6ApiException
  {
    Sort paramDtypeSort = create_param_datatype_sort();
  ...
  @Test
  void getInstantiatedParameters() throws AVA6ApiException
  {
    Sort intSort = d_tm.getIntegerSort();
    ...
    assertThrows(AVA6ApiException.class, () -> paramDtypeSort.getInstantiatedParameters());
    ...
    assertThrows(AVA6ApiException.class, () -> sortConsSort.getInstantiatedParameters());
    ...
    assertThrows(AVA6ApiException.class, () -> intSort.getInstantiatedParameters());
    assertThrows(AVA6ApiException.class, () -> bvSort.getInstantiatedParameters());
  }

  @Test
  void getUninterpretedSortConstructor() throws AVA6ApiException
  {
    Sort intSort = d_tm.getIntegerSort();
    Sort realSort = d_tm.getRealSort();
    Sort boolSort = d_tm.getBooleanSort();
    ...
    assertThrows(AVA6ApiException.class, () -> sortConsSort.getUninterpretedSortConstructor());
    Sort instSortConsSort =
        sortConsSort.instantiate(new Sort[] {boolSort, intSort, bvSort, realSort});
  ...
  @Test
  void getFunctionArity() throws AVA6ApiException
  {
    ...
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getFunctionArity());
  }

  @Test
  void getFunctionDomainSorts() throws AVA6ApiException
  {
    Sort funSort = d_tm.mkFunctionSort(d_tm.mkUninterpretedSort("u"), d_tm.getIntegerSort());
    assertDoesNotThrow(() -> funSort.getFunctionDomainSorts());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getFunctionDomainSorts());
  }

  @Test
  void getFunctionCodomainSort() throws AVA6ApiException
  {
    Sort funSort = d_tm.mkFunctionSort(d_tm.mkUninterpretedSort("u"), d_tm.getIntegerSort());
    assertDoesNotThrow(() -> funSort.getFunctionCodomainSort());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getFunctionCodomainSort());
  }

  @Test
  void getArrayIndexSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> indexSort.getArrayIndexSort());
  }

  @Test
  void getArrayElementSort() throws AVA6ApiException
  {
    Sort elementSort = d_tm.mkBitVectorSort(32);
    Sort indexSort = d_tm.mkBitVectorSort(32);
    Sort arraySort = d_tm.mkArraySort(indexSort, elementSort);
    assertDoesNotThrow(() -> arraySort.getArrayElementSort());
    assertThrows(AVA6ApiException.class, () -> indexSort.getArrayElementSort());
  }

  @Test
  void getSetElementSort() throws AVA6ApiException
  {
    ...
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getSetElementSort());
  }

  @Test
  void getBagElementSort() throws AVA6ApiException
  {
    ...
    assertEquals(elementSort, d_tm.getIntegerSort());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getBagElementSort());
  }

  @Test
  void getSequenceElementSort() throws AVA6ApiException
  {
    ...
    assertThrows(AVA6ApiException.class, () -> bvSort.getSequenceElementSort());
  }

  @Test
  void getAbstractedKind() throws AVA6ApiException
  {
    assertEquals(
    ...
    // extracted.
    assertThrows(
        AVA6ApiException.class, () -> d_tm.mkAbstractSort(SortKind.ARRAY_SORT).getAbstractedKind());
    assertEquals(
        d_tm.mkAbstractSort(SortKind.ABSTRACT_SORT).getAbstractedKind(), SortKind.ABSTRACT_SORT);
  }

  @Test
  void getSymbol() throws AVA6ApiException
  {
    Sort uSort = d_tm.mkUninterpretedSort("u");
    assertDoesNotThrow(() -> uSort.getSymbol());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getSymbol());
  }

  @Test
  void getUninterpretedSortConstructorName() throws AVA6ApiException
  {
  ...
  @Test
  void getUninterpretedSortConstructorArity() throws AVA6ApiException
  {
    Sort sSort = d_tm.mkUninterpretedSortConstructorSort(2, "s");
    assertDoesNotThrow(() -> sSort.getUninterpretedSortConstructorArity());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getUninterpretedSortConstructorArity());
  }

  @Test
  void getBitVectorSize() throws AVA6ApiException
  {
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertDoesNotThrow(() -> bvSort.getBitVectorSize());
    Sort setSort = d_tm.mkSetSort(d_tm.getIntegerSort());
    assertThrows(AVA6ApiException.class, () -> setSort.getBitVectorSize());
  }

  @Test
  void getFloatingPointExponentSize() throws AVA6ApiException
  {
    Sort fpSort = d_tm.mkFloatingPointSort(4, 8);
    assertDoesNotThrow(() -> fpSort.getFloatingPointExponentSize());
    Sort setSort = d_tm.mkSetSort(d_tm.getIntegerSort());
    assertThrows(AVA6ApiException.class, () -> setSort.getFloatingPointExponentSize());
  }

  @Test
  void getFloatingPointSignificandSize() throws AVA6ApiException
  {
    Sort fpSort = d_tm.mkFloatingPointSort(4, 8);
    assertDoesNotThrow(() -> fpSort.getFloatingPointSignificandSize());
    Sort setSort = d_tm.mkSetSort(d_tm.getIntegerSort());
    assertThrows(AVA6ApiException.class, () -> setSort.getFloatingPointSignificandSize());
  }

  @Test
  void getDatatypeArity() throws AVA6ApiException
  {
    ...
    // create bv sort, check should fail
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getDatatypeArity());
  }

  @Test
  void getTupleLength() throws AVA6ApiException
  {
    ...
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getTupleLength());
  }

  @Test
  void getTupleSorts() throws AVA6ApiException
  {
    Sort tupleSort = d_tm.mkTupleSort(new Sort[] {d_tm.getIntegerSort(), d_tm.getIntegerSort()});
    assertDoesNotThrow(() -> tupleSort.getTupleSorts());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getTupleSorts());
  }

  @Test
  void getNullableElementSort() throws AVA6ApiException
  {
    ...
    assertEquals(elementSort, d_tm.getIntegerSort());
    Sort bvSort = d_tm.mkBitVectorSort(32);
    assertThrows(AVA6ApiException.class, () -> bvSort.getNullableElementSort());
  }

  @Test
  void sortCompare() throws AVA6ApiException
  {
    Sort boolSort = d_tm.getBooleanSort();
    Sort intSort = d_tm.getIntegerSort();
    Sort bvSort = d_tm.mkBitVectorSort(32);
  ...
  @Test
  void sortScopedToString() throws AVA6ApiException
  {
  ...
  @Test
  void sortSubstitute() throws AVA6ApiException
  {
