...
class OpTest
{
  ...
  @Test
  void hash() throws AVA6ApiException
  {
  ...
  void opFromKind()
  {
    ...
    assertThrows(AVA6ApiException.class, () -> d_tm.mkOp(BITVECTOR_EXTRACT));
  }

  @Test
  void getNumIndices() throws AVA6ApiException
  {
  ...
  @Test
  void opSubscriptOperator() throws AVA6ApiException
  {
    // Operators with 0 indices
    Op plus = d_tm.mkOp(ADD);

    assertThrows(AVA6ApiException.class, () -> plus.get(0));
  ...
  @Test
  void opScopingToString() throws AVA6ApiException
  {
