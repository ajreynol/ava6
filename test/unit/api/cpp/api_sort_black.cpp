...
TEST_F(TestApiBlackSort, hasGetSymbol)
{
  ...
  ASSERT_THROW(b.getSymbol(), Ava6ApiException);
...
TEST_F(TestApiBlackSort, isDatatypeConstructor)
{
  ...
  ASSERT_THROW(dt[3], Ava6ApiException);
...
TEST_F(TestApiBlackSort, isDatatypeSelector)
{
  ...
  ASSERT_THROW(dt[0][2], Ava6ApiException);
...
TEST_F(TestApiBlackSort, getDatatype)
{
  ...
  ASSERT_THROW(bvSort.getDatatype(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, datatypeSorts)
{
  ...
  ASSERT_THROW(dtypeSort.getDatatypeConstructorCodomainSort(),
               Ava6ApiException);
  ASSERT_THROW(dtypeSort.getDatatypeConstructorDomainSorts(), Ava6ApiException);
  ASSERT_THROW(dtypeSort.getDatatypeConstructorArity(), Ava6ApiException);
  ...
  ASSERT_THROW(booleanSort.getDatatypeTesterDomainSort(), Ava6ApiException);
  ASSERT_THROW(booleanSort.getDatatypeTesterCodomainSort(), Ava6ApiException);
  ...
  ASSERT_THROW(booleanSort.getDatatypeSelectorDomainSort(), Ava6ApiException);
  ASSERT_THROW(booleanSort.getDatatypeSelectorCodomainSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getInstantiatedParameters)
{
  ...
  ASSERT_THROW(paramDtypeSort.getInstantiatedParameters(), Ava6ApiException);
  ...
  ASSERT_THROW(sortConsSort.getInstantiatedParameters(), Ava6ApiException);
  ...
  ASSERT_THROW(intSort.getInstantiatedParameters(), Ava6ApiException);
  ASSERT_THROW(bvSort.getInstantiatedParameters(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getFunctionArity)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getFunctionArity(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getFunctionDomainSorts)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getFunctionDomainSorts(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getFunctionCodomainSort)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getFunctionCodomainSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getArrayIndexSort)
{
  ...
  ASSERT_THROW(indexSort.getArrayIndexSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getArrayElementSort)
{
  ...
  ASSERT_THROW(indexSort.getArrayElementSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getSetElementSort)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getSetElementSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getSequenceElementSort)
{
  ...
  ASSERT_THROW(bvSort.getSequenceElementSort(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getSymbol)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getSymbol(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getUninterpretedSortConstructorArity)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getUninterpretedSortConstructorArity(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getBitVectorSize)
{
  ...
  Sort setSort = d_tm.mkSetSort(d_tm.getIntegerSort());
  ASSERT_THROW(setSort.getBitVectorSize(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getDatatypeArity)
{
  ...
  // create bv sort, check should fail
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getDatatypeArity(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getTupleLength)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getTupleLength(), Ava6ApiException);
}
...
TEST_F(TestApiBlackSort, getTupleSorts)
{
  ...
  Sort bvSort = d_tm.mkBitVectorSort(32);
  ASSERT_THROW(bvSort.getTupleSorts(), Ava6ApiException);
}
