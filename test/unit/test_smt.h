...
#ifndef AVA6__TEST__UNIT__TEST_SMT_H
#define AVA6__TEST__UNIT__TEST_SMT_H
...
class DummyOutputChannel : public theory::OutputChannel
{
 public:
  ...
  void safePoint(AVA6_UNUSED Resource r) override {}
  void conflict(TNode n, AVA6_UNUSED theory::InferenceId id) override
  {
    push(CONFLICT, n);
  }

  void trustedConflict(TrustNode n, AVA6_UNUSED theory::InferenceId id) override
  {
  ...
  void lemma(TNode n,
             AVA6_UNUSED theory::InferenceId id,
             AVA6_UNUSED theory::LemmaProperty p =
  ...
  void trustedLemma(TrustNode n,
                    AVA6_UNUSED theory::InferenceId id,
                    AVA6_UNUSED theory::LemmaProperty p) override
  {
    push(LEMMA, n.getNode());
  }

  void preferPhase(TNode, bool) override {}
  void setModelUnsound(AVA6_UNUSED theory::IncompleteId id) override {}
  void setRefutationUnsound(AVA6_UNUSED theory::IncompleteId id) override {}
...
class DummyProofRuleChecker : public ProofRuleChecker
{
 public:
  ...
  void registerTo(AVA6_UNUSED ProofChecker* pc) override {}

 protected:
  Node checkInternal(AVA6_UNUSED ProofRule id,
                     AVA6_UNUSED const std::vector<Node>& children,
                     AVA6_UNUSED const std::vector<Node>& args) override
  {
    return Node::null();
  }
};
...
class DummyTheory : public theory::Theory
{
 public:
  ...
  void preRegisterTerm(AVA6_UNUSED TNode n) override { Unimplemented(); }
  void propagate(AVA6_UNUSED Effort level) override { Unimplemented(); }
  bool preNotifyFact(AVA6_UNUSED TNode atom,
                     AVA6_UNUSED bool pol,
                     AVA6_UNUSED TNode fact,
                     AVA6_UNUSED bool isPrereg,
                     AVA6_UNUSED bool isInternal) override
  {
    // do not assert to equality engine, since this theory does not use one
    return true;
  }
  TrustNode explain(AVA6_UNUSED TNode n) override { return TrustNode::null(); }
  Node getValue(AVA6_UNUSED TNode n) { return Node::null(); }
