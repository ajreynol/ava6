...
class TestUtilWhiteCheck : public TestInternal
{
 protected:
  ...
  std::string terminalAva6Fatal() const
  {
    AVA6_FATAL() << "This is a test that confirms that AVA6_FATAL can be a "
...
#ifndef AVA6_ASSERTIONS
  Assert(false) << "Will not be compiled in when AVA6_ASSERTIONS off.";
#endif
}
