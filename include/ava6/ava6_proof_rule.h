 ...
 */
     ...
     && !defined(AVA6__API__AVA6_CPP_PROOF_RULE_H)) \
    || (defined(AVA6_API_USE_C_ENUMS)               \
        && !defined(AVA6__API__AVA6_C_PROOF_RULE_H))
...
#ifdef AVA6_API_USE_C_ENUMS
#undef EVALUE
#define EVALUE(name) AVA6_PROOF_RULE_##name
#endif
 ...
 * (1) :cpp:enumerator:`ASSUME <ava6::ProofRule::ASSUME>`, which represents an
 * open leaf in a proof; and
 * (2) :cpp:enumerator:`SCOPE <ava6::ProofRule::SCOPE>`, which encloses a scope
...
enum ENUM(ProofRule)
{
   ...
   * bound by :cpp:enumerator:`SCOPE <ava6::ProofRule::SCOPE>` (see below).
   * \endverbatim
   */
  EVALUE(ASSUME),
  /**
   ...
   * :cpp:enumerator:`ASSUME <ava6::ProofRule::ASSUME>`. It is a way to close
   ...
   *
   * Note that ava6 internally has a notion of which terms denote "values".
   ...
   * :ava6src:`theory/builtin/proof_checker.h`.
   * \endverbatim
   */
   ...
   * :cpp:enumerator:`MACRO_SR_EQ_INTRO <ava6::ProofRule::MACRO_SR_EQ_INTRO>`.
   * \endverbatim
   */
   ...
   * :cpp:enumerator:`MACRO_SR_PRED_INTRO <ava6::ProofRule::MACRO_SR_PRED_INTRO>`
   * above.
   * \endverbatim
   */
   ...
   * :ava6src:`expr/nary_term_util.h`) which replaces each :math:`x_i` with the
   ...
   *   :cpp:enumerator:`RESOLUTION <ava6::ProofRule::RESOLUTION>`
   ...
   * :cpp:enumerator:`EQUIV_ELIM1 <ava6::ProofRule::EQUIV_ELIM1>` +
   * :cpp:enumerator:`RESOLUTION <ava6::ProofRule::RESOLUTION>`.
   * \endverbatim
   */
  EVALUE(EQ_RESOLVE),
   ...
   *
   * Note this can optionally be seen as a macro for
   * :cpp:enumerator:`IMPLIES_ELIM <ava6::ProofRule::IMPLIES_ELIM>` +
   * :cpp:enumerator:`RESOLUTION <ava6::ProofRule::RESOLUTION>`.
   * \endverbatim
   */
  EVALUE(MODUS_PONENS),
   ...
   * arity. This includes kinds such as ``ava6::Kind::ITE``,
   * ``ava6::Kind::EQUAL``, as well as indexed functions such as
   * ``ava6::Kind::BITVECTOR_EXTRACT``.
   *
   ...
   * such as ``ava6::Kind::AND``, ``ava6::Kind::PLUS`` and so on.
   * \endverbatim
   */
  EVALUE(NARY_CONG),
  /**
   ...
   * strategies defined in :ava6src:`theory/bv/bitblast/bitblast_strategies_template.h`.
   * \endverbatim
   */
   ...
   * :cpp:enumerator:`QUANTIFIERS_SKOLEMIZE <ava6::SkolemId::QUANTIFIERS_SKOLEMIZE>`,
   ...
   * :cpp:enumerator:`WITNESS_STRING_LENGTH <ava6::SkolemId::WITNESS_STRING_LENGTH>`.
   *
   * \endverbatim
   */
   ...
   * :ava6src:`theory/strings/theory_strings_preprocess.h`.
   ...
   * For details, see :ava6src:`theory/strings/term_registry.h`.
   * \endverbatim
   */
   ...
   * :ava6src:`theory/arith/operator_elim.h`.
   * \endverbatim
   */
   ...
   * :cpp:enumerator:`TRANSCENDENTAL_PURIFY_ARG <ava6::SkolemId::TRANSCENDENTAL_PURIFY_ARG>`
   * skolem for :math:`\sin(x)` and :math:`s` is the
   * :cpp:enumerator:`TRANSCENDENTAL_SINE_PHASE_SHIFT <ava6::SkolemId::TRANSCENDENTAL_SINE_PHASE_SHIFT>`
   * skolem for :math:`x`.
   * \endverbatim
   */
   ...
   * \dots, r_k)` and :math:`\mathtt{Seq}_m = (m_1, \dots, m_k)` are a sequence
   * of polynomials, such that :math:`p = \sum_i^k m_i * r_i`.
   * This macro is elaborated by applications of :cpp:enumerator:`FF_POLY_COMBINATION <ava6::ProofRule::FF_POLY_COMBINATION>`,
   * :cpp:enumerator:`FF_ARITH_POLY_NORM <ava6::ProofRule::ARITH_POLY_NORM>`,
   * :cpp:enumerator:`REFL <ava6::ProofRule::REFL>`,
   * :cpp:enumerator:`CONG <ava6::ProofRule::CONG>`,
   * :cpp:enumerator:`EQ_RESOLVE <ava6::ProofRule::EQ_RESOLVE>`.
   * \endverbatim
   */
...
#ifdef AVA6_API_USE_C_ENUMS
#undef EVALUE
#define EVALUE(name) AVA6_PROOF_REWRITE_RULE_##name
#endif
 ...
 * the :cpp:enumerator:`DSL_REWRITE <ava6::ProofRule::DSL_REWRITE>` proof rule
 * and the :cpp:enumerator:`THEORY_REWRITE <ava6::ProofRule::THEORY_REWRITE>`
 * proof rule.
 * \endverbatim
 */
enum ENUM(ProofRewriteRule)
{
   ...
   * :cpp:enumerator:`ARITH_POLY_NORM <ava6::ProofRule::ARITH_POLY_NORM>`) to
   ...
   * This macro is elaborated by applications of :cpp:enumerator:`EVALUATE <ava6::ProofRule::EVALUATE>`,
   * :cpp:enumerator:`ARITH_POLY_NORM <ava6::ProofRule::ARITH_POLY_NORM>`,
   * :cpp:enumerator:`ARITH_STRING_PRED_ENTAIL <ava6::ProofRewriteRule::ARITH_STRING_PRED_ENTAIL>`,
   * :cpp:enumerator:`ARITH_STRING_PRED_SAFE_APPROX <ava6::ProofRewriteRule::ARITH_STRING_PRED_SAFE_APPROX>`,
   ...
   * :cpp:enumerator:`STR_OVERLAP_SPLIT_CTN <ava6::ProofRewriteRule::STR_OVERLAP_SPLIT_CTN>`.
   *
   * \endverbatim
   */
   ...
   * is elaborated  using
   * :cpp:enumerator:`STR_OVERLAP_ENDPOINTS_CTN <ava6::ProofRewriteRule::STR_OVERLAP_ENDPOINTS_CTN>`,
   * :cpp:enumerator:`STR_OVERLAP_ENDPOINTS_INDEXOF <ava6::ProofRewriteRule::STR_OVERLAP_ENDPOINTS_INDEXOF>` and
   * :cpp:enumerator:`STR_OVERLAP_ENDPOINTS_REPLACE <ava6::ProofRewriteRule::STR_OVERLAP_ENDPOINTS_REPLACE>`.
   *
   * \endverbatim
   */
   ...
   * :math:`\texttt{Word::hasOverlap}` in :ava6src:`theory/strings/word.h`.
   * \endverbatim
   */
...
/**
 * Get a string representation of a Ava6ProofRule.
 * @param rule The proof rule.
 * @return The string representation.
 */
AVA6_EXPORT const char* ava6_proof_rule_to_string(Ava6ProofRule rule);

/**
 * Hash function for Ava6ProofRule.
 * @param rule The proof rule.
 * @return The hash value.
 */
AVA6_EXPORT size_t ava6_proof_rule_hash(Ava6ProofRule rule);

/**
 * Get a string representation of a Ava6ProofRewriteRule.
 * @param rule The proof rewrite rule.
 * @return The string representation.
 */
AVA6_EXPORT const char* ava6_proof_rewrite_rule_to_string(
    Ava6ProofRewriteRule rule);

/**
 * Hash function for Ava6ProofRewriteRule.
 * @param rule The proof rewrite rule.
 * @return The hash value.
 */
AVA6_EXPORT size_t ava6_proof_rewrite_rule_hash(Ava6ProofRewriteRule rule);
 ...
 */
AVA6_EXPORT const char* toString(ProofRule rule);
 ...
 * @return The stream
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, ProofRule rule);
 ...
 */
AVA6_EXPORT const char* toString(ProofRewriteRule rule);
 ...
 * @return The stream
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, ProofRewriteRule rule);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::ProofRule>
{
  /**
   ...
   * @return The hash value.
   */
  size_t operator()(ava6::ProofRule rule) const;
};
 ...
 * @return The name of the proof rule
 */
AVA6_EXPORT std::string to_string(ava6::ProofRule rule);

/**
 * Hash function for ProofRewriteRules.
 */
template <>
struct AVA6_EXPORT hash<ava6::ProofRewriteRule>
{
  /**
   ...
   * @return The hash value.
   */
  size_t operator()(ava6::ProofRewriteRule rule) const;
};
 ...
 * @return The name of the proof rewrite rule
 */
AVA6_EXPORT std::string to_string(ava6::ProofRewriteRule rule);
...
#ifdef AVA6_API_USE_C_ENUMS
#ifndef AVA6__API__AVA6_C_PROOF_RULE_H
#define AVA6__API__AVA6_C_PROOF_RULE_H
#endif
#else
#ifndef AVA6__API__AVA6_CPP_PROOF_RULE_H
#define AVA6__API__AVA6_CPP_PROOF_RULE_H
#endif
#endif
