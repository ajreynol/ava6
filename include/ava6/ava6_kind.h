 ...
 * ****************************************************************************
 *
 * The term kinds of the ava6 C++ and C APIs.
 */

#if (!defined(AVA6_API_USE_C_ENUMS) && !defined(AVA6__API__AVA6_CPP_KIND_H)) \
    || (defined(AVA6_API_USE_C_ENUMS) && !defined(AVA6__API__AVA6_C_KIND_H))
...
#ifdef AVA6_API_USE_C_ENUMS
#undef EVALUE
#define EVALUE(name) AVA6_KIND_##name
#endif

// clang-format off
/**
 * The kind of a ava6 Term.
 *
 * \internal
 *
 * Note that the API type `ava6::Kind` roughly corresponds to
 * `ava6::internal::Kind`, but is a different type. It hides internal kinds
 ...
 * `ava6::Kind` must be signed (to enable range checks for validity). The size
 * of this type depends on the size of `ava6::internal::Kind`
...
#ifdef AVA6_API_USE_C_ENUMS
/**
 * Get a string representation of a Ava6Kind.
 * @param kind The kind.
 * @return The string representation.
 */
AVA6_EXPORT const char* ava6_kind_to_string(Ava6Kind kind);
#else
/**
 ...
 */
[[deprecated("use std::to_string(Kind) instead.")]] AVA6_EXPORT std::string
 ...
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, Kind kind);
 ...
 * @return The string representation.
 */
AVA6_EXPORT std::string to_string(ava6::Kind kind);
}
#endif

#ifdef AVA6_API_USE_C_ENUMS
/**
 * Hash function for Ava6Kinds.
 * @param kind The kind.
 * @return The hash value.
 */
AVA6_EXPORT size_t ava6_kind_hash(Ava6Kind kind);
#else
namespace std {
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Kind>
{
  /**
   ...
   * @return The hash value.
   */
  size_t operator()(ava6::Kind kind) const;
};
...
#ifdef AVA6_API_USE_C_ENUMS
#undef EVALUE
#define EVALUE(name) AVA6_SORT_KIND_##name
#endif
...
// clang-format off
/**
 * The kind of a ava6 Sort.
 *
 * \internal
 *
 * Note that the API type `ava6::SortKind` roughly corresponds to
 * `ava6::internal::Kind`, but is a different type. It hides internal kinds
 * that should not be exported to the API, and maps all kinds that we want to
 * export to its corresponding internal kinds. The underlying type of
 * `ava6::Kind` must be signed (to enable range checks for validity). The size
...
#ifdef AVA6_API_USE_C_ENUMS
/**
 * Get a string representation of a Ava6SortKind.
 * @param kind The sort kind.
 * @return The string representation.
 */
AVA6_EXPORT const char* ava6_sort_kind_to_string(Ava6SortKind kind);
#else
/**
 * Get the string representation of a given kind.
 ...
 *          release.
 */
[[deprecated("use std::to_string(SortKind) instead.")]] AVA6_EXPORT std::string
 ...
 * @return the output stream
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, SortKind k);
 ...
 * @return the string representation of kind k
 */
AVA6_EXPORT std::string to_string(ava6::SortKind k);
}
#endif

#ifdef AVA6_API_USE_C_ENUMS
/**
 * Hash function for Ava6SortKinds.
 * @param kind The kind.
 * @return The hash value.
 */
AVA6_EXPORT size_t ava6_sort_kind_hash(Ava6SortKind kind);
#else
namespace std {
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::SortKind>
{
  /**
   ...
   * @return The hash value.
   */
  size_t operator()(ava6::SortKind kind) const;
};
}  // namespace std
#endif
...
#ifdef AVA6_API_USE_C_ENUMS
#ifndef AVA6__API__AVA6_C_KIND_H
#define AVA6__API__AVA6_C_KIND_H
#endif
#else
#ifndef AVA6__API__AVA6_CPP_KIND_H
#define AVA6__API__AVA6_CPP_KIND_H
#endif
#endif
