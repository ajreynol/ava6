...
#ifndef AVA6__API__AVA6_PARSER_H
#define AVA6__API__AVA6_PARSER_H
 ...
 */
class AVA6_EXPORT SymbolManager
{
 ...
 public:
   ...
   */
  SymbolManager(ava6::TermManager& tm);
  /**
   * Constructor.
...
class AVA6_EXPORT Command
{
 ...
 public:
   ...
   */
  void invoke(ava6::Solver* solver,
...
AVA6_EXPORT std::ostream& operator<<(std::ostream&, const Command&);
 ...
 */
class AVA6_EXPORT ParserException : public Ava6ApiException
{
 public:
  /** Default constructor */
  ParserException();
 ...
 * If thrown, API objects can still be used
 */
class AVA6_EXPORT ParserEndOfFileException : public ParserException
{
 public:
  /** default constructor */
