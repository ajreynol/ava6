...
#ifndef AVA6__API__AVA6_H
#define AVA6__API__AVA6_H

#include <ava6/ava6_kind.h>
 ...
 */
class AVA6_EXPORT Ava6ApiException : public std::exception
{
 public:
  /**
   ...
   */
  Ava6ApiException(const std::string& str) : d_msg(str) {}
  /**
   * Construct with message from a string stream.
   * @param stream The error message.
   */
  Ava6ApiException(const std::stringstream& stream) : d_msg(stream.str()) {}
  /**
...
inline std::ostream& operator<<(std::ostream& os, const Ava6ApiException& e)
{
  e.toStream(os);
  return os;
}
 ...
 */
class AVA6_EXPORT Ava6ApiRecoverableException : public Ava6ApiException
{
 public:
  /**
   * Construct with message from a string.
   * @param str The error message.
   */
  Ava6ApiRecoverableException(const std::string& str) : Ava6ApiException(str) {}
  /**
   * Construct with message from a string stream.
   * @param stream The error message.
   */
  Ava6ApiRecoverableException(const std::stringstream& stream)
      : Ava6ApiException(stream.str())
  {
  }
};
 ...
 * If thrown, API objects can still be used.
 */
class AVA6_EXPORT Ava6ApiUnsupportedException
    : public Ava6ApiRecoverableException
{
 public:
  /**
   * Construct with message from a string.
   * @param str The error message.
   */
  Ava6ApiUnsupportedException(const std::string& str)
      : Ava6ApiRecoverableException(str)
  {
  }
  /**
   * Construct with message from a string stream.
   * @param stream The error message.
   */
  Ava6ApiUnsupportedException(const std::stringstream& stream)
      : Ava6ApiRecoverableException(stream.str())
  {
  }
};
 ...
 * If thrown, API objects can still be used.
 */
class AVA6_EXPORT Ava6ApiOptionException : public Ava6ApiRecoverableException
{
 public:
  /**
   * Construct with message from a string.
   * @param str The error message.
   */
  Ava6ApiOptionException(const std::string& str)
      : Ava6ApiRecoverableException(str)
  {
  }
  /**
   ...
   * @param stream The error message.
   */
  Ava6ApiOptionException(const std::stringstream& stream)
      : Ava6ApiRecoverableException(stream.str())
  {
  }
};
...
class AVA6_EXPORT Result
{
 ...
 public:
   ...
   *         and ava6 was not able to determine (un)satisfiability.
   */
 ...
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Result& r);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Result>
{
  size_t operator()(const ava6::Result& result) const;
};
}  // namespace std
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const SynthResult& r);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::SynthResult>
{
  size_t operator()(const ava6::SynthResult& result) const;
};
}  // namespace std
...
/**
 * The sort of a ava6 term.
 */
class AVA6_EXPORT Sort
{
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Sort& s);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Sort>
{
  size_t operator()(const ava6::Sort& s) const;
};
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Op& op);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Op>
{
  size_t operator()(const ava6::Op& op) const;
};
}  // namespace std
...
class AVA6_EXPORT Term
{
 ...
 public:
   ...
   */
  class AVA6_EXPORT const_iterator
  {
    friend class Term;
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Term& t);
 ...
 */
template <typename V>
AVA6_EXPORT std::ostream& operator<<(std::ostream& out,
 ...
 */
template <typename V>
AVA6_EXPORT std::ostream& operator<<(
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Term>
{
  size_t operator()(const ava6::Term& t) const;
};
}  // namespace std
...
/**
 * A ava6 datatype constructor declaration. A datatype constructor declaration
 * is a specification used for creating a datatype constructor.
 */
class AVA6_EXPORT DatatypeConstructorDecl
{
  friend class DatatypeDecl;
  friend class TermManager;
  friend class Solver;
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::DatatypeConstructorDecl>
{
  size_t operator()(const ava6::DatatypeConstructorDecl& decl) const;
};
}  // namespace std
...
/**
 * A ava6 datatype declaration. A datatype declaration is not itself a datatype
 ...
 */
class AVA6_EXPORT DatatypeDecl
{
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::DatatypeDecl>
{
  size_t operator()(const ava6::DatatypeDecl& decl) const;
};
}  // namespace std
...
/**
 * A ava6 datatype selector.
 */
class AVA6_EXPORT DatatypeSelector
{
  friend class Datatype;
  friend class DatatypeConstructor;
  friend class TermManager;
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::DatatypeSelector>
{
  size_t operator()(const ava6::DatatypeSelector& sel) const;
};
}  // namespace std
...
/**
 * A ava6 datatype constructor.
 */
class AVA6_EXPORT DatatypeConstructor
{
  friend class Datatype;
  friend class TermManager;
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::DatatypeConstructor>
{
  size_t operator()(const ava6::DatatypeConstructor& cons) const;
};
}  // namespace std
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Datatype& dtype);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Datatype>
{
  size_t operator()(const ava6::Datatype& dt) const;
};
}  // namespace std
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& out, const Grammar& grammar);
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Grammar>
{
  size_t operator()(const ava6::Grammar& grammar) const;
};
}  // namespace std
 ...
 * regular :cpp:func:`Solver::getOption() <ava6::Solver::getOption()>` or
 * :cpp:func:`Solver::getOptionInfo() <ava6::Solver::getOptionInfo()>`
 ...
 */
class AVA6_EXPORT DriverOptions
{
  friend class Solver;
 ...
 * :cpp:func:`Solver::getOptionInfo() <ava6::Solver::getOptionInfo()>` and
 * allows for a more detailed inspection of options than
 * :cpp:func:`Solver::getOption() <ava6::Solver::getOption()>`. The
 * :cpp:member:`valueInfo <ava6::OptionInfo::valueInfo>` member holds any of the
 * following alternatives:
 *
 * - :cpp:class:`VoidInfo <ava6::OptionInfo::VoidInfo>` if the option holds no
 *   value (or the value has no native type)
 * - :cpp:class:`ValueInfo <ava6::OptionInfo::ValueInfo>` if the option is of
 *   type ``bool`` or ``std::string``, holds the current value and the default
 *   value.
 * - :cpp:class:`NumberInfo <ava6::OptionInfo::NumberInfo>` if the option is of
 *   type ``int64_t``, ``uint64_t`` or ``double``, holds the current and default
 *   value, as well as the minimum and maximum.
 * - :cpp:class:`ModeInfo <ava6::OptionInfo::ModeInfo>` if the option is a mode
 ...
 * <ava6::OptionInfo::boolValue()>`, :cpp:func:`stringValue()
 * <ava6::OptionInfo::stringValue()>`, :cpp:func:`intValue()
 * <ava6::OptionInfo::intValue()>`, :cpp:func:`uintValue()
 * <ava6::OptionInfo::uintValue()>` and :cpp:func:`doubleValue()
 * <ava6::OptionInfo::doubleValue()>`. They assert that the option has the
 * respective type and return the current value.
 *
 * If the option has a special type that is not covered by the above
 * alternatives, the :cpp:member:`valueInfo <ava6::OptionInfo::valueInfo>` holds
 * a :cpp:class:`VoidInfo <ava6::OptionInfo::VoidInfo>`. Some options, that are
 * expected to be used by frontends (e.g., input and output streams) can also
 * be accessed using :cpp:func:`Solver::getDriverOptions()
 * <ava6::Solver::getDriverOptions()>`. \endverbatim
 */
struct AVA6_EXPORT OptionInfo
{
 ...
 * @return The output stream.
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& os, const OptionInfo& oi);
 ...
 * :cpp:func:`isInternal() <ava6::Stat::isInternal()>` and whether its value is
 * the default value by :cpp:func:`isDefault() <ava6::Stat::isDefault()>`.
 * \endverbatim
 */
class AVA6_EXPORT Stat
{
  struct StatData;

 public:
  friend class Statistics;
  AVA6_EXPORT friend std::ostream& operator<<(std::ostream& os, const Stat& sv);
 ...
 */
AVA6_EXPORT std::ostream& operator<<(std::ostream& os, const Stat& stat);
...
class AVA6_EXPORT Statistics
{
 public:
   ...
   *       throws a Ava6ApiRecoverableException if it does not.
...
/**
 * A ava6 proof.  Proofs are trees and every proof object corresponds to the
 * root step of a proof.  The branches of the root step are the premises of
 * the step.
 */
class AVA6_EXPORT Proof
{
  friend class Solver;
 ...
 */
template <>
struct AVA6_EXPORT hash<ava6::Proof>
{
  size_t operator()(const ava6::Proof& p) const;
};
}  // namespace std
...
class AVA6_EXPORT TermManager
{
 ...
 public:
   ...
   *   - #TUPLE_PROJECT
   *
   * See ava6::Kind for a description of the parameters.
   * @param kind The kind of the operator.
   * @param args The arguments (indices) of the operator.
   *
   * @note If ``args`` is empty, the Op simply wraps the ava6::Kind.  The
...
class AVA6_EXPORT Solver
{
 ...
 public:
   ...
   *
   * .. note::
   *   In contrast to SMT-LIB, ava6's API does not distinguish between named
