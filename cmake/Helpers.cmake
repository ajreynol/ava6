...
macro(ava6_set_option var value)
...
# indicate when a given dependency is built as part of the ava6 build.
...
# Collect all source files that are required to build libava6 in LIBAVA6_SRCS
# or LIBAVA6_GEN_SRCS. If GENERATED is the first argument the sources are
# added to LIBAVA6_GEN_SRCS. All sources are prepended with the absolute
# current path path. CMAKE_CURRENT_BINARY_DIR is prepended
# to generated source files.
macro(libava6_add_sources)
  set(_sources ${ARGV})
  ...
  if(${_generated} STREQUAL "GENERATED")
    ...
    set(_append_to LIBAVA6_GEN_SRCS)
  else()
    set(_cur_path ${CMAKE_CURRENT_SOURCE_DIR})
    set(_append_to LIBAVA6_SRCS)
  endif()
