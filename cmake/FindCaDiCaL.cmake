...
if(CaDiCaL_INCLUDE_DIR AND CaDiCaL_LIBRARIES)
  ...
  # ava6 doesn't support MSVC, so we're fine to hard-code `-I` as the include
  # flag
...
if(NOT CaDiCaL_FOUND_SYSTEM)
  ...
  # emcc defaults to -fignore-exceptions, which emits no landing pads. ava6
...
if (WIN32)
  ...
  # of the CaDiCaL library (without this, linking a static ava6 executable
  # fails).
  set_target_properties(
