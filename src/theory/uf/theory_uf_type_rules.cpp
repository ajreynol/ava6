...
TypeNode UfTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                    AVA6_UNUSED TNode n)
{
...
TypeNode FunctionArrayConstTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                    AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode IntToBitVectorOpTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                  AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode DistinctTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
