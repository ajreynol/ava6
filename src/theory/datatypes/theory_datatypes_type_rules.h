...
#ifndef AVA6__THEORY__DATATYPES__THEORY_DATATYPES_TYPE_RULES_H
#define AVA6__THEORY__DATATYPES__THEORY_DATATYPES_TYPE_RULES_H
...
#endif /* AVA6__THEORY__DATATYPES__THEORY_DATATYPES_TYPE_RULES_H */
