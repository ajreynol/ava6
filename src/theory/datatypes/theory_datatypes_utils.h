...
#ifndef AVA6__THEORY__DATATYPES__THEORY_DATATYPES_UTILS_H
#define AVA6__THEORY__DATATYPES__THEORY_DATATYPES_UTILS_H
 ...
 */
AVA6_NO_DANGLING const DType& datatypeOf(Node n);
