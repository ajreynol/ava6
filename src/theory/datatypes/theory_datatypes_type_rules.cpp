...
TypeNode DatatypeConstructorTypeRule::preComputeType(
    AVA6_UNUSED NodeManager* nm, TNode n)
{
...
TypeNode DatatypeSelectorTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                  AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode DatatypeUpdateTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode DatatypeAscriptionTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                    TNode n)
{
...
TypeNode DtSizeTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
...
TypeNode DtBoundTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
  return nm->booleanType();
}
...
TypeNode DtSygusEvalTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                             AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
TypeNode DtSygusEvalTypeRule::computeType(AVA6_UNUSED NodeManager* nodeManager,
                                          TNode n,
                                          bool check,
                                          std::ostream* errOut)
{
...
TypeNode MatchTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                       AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
TypeNode MatchTypeRule::computeType(AVA6_UNUSED NodeManager* nodeManager,
                                    TNode n,
                                    ...
                                    std::ostream* errOut)
{
  ...
  for (unsigned i = 1, nchildren = n.getNumChildren(); i < nchildren; i++)
  {
    ...
    if (!AVA6_EQUAL(hdt.getTypeNode(), pdt.getTypeNode()))
    {
      if (errOut)
      {
        (*errOut)
...
TypeNode MatchCaseTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                           AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
TypeNode MatchCaseTypeRule::computeType(AVA6_UNUSED NodeManager* nodeManager,
                                        TNode n,
                                        bool check,
                                        std::ostream* errOut)
{
...
TypeNode MatchBindCaseTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                               AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode TupleProjectTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                              AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}

TypeNode TupleProjectTypeRule::computeType(AVA6_UNUSED NodeManager* nm,
                                           TNode n,
                                           bool check,
                                           std::ostream* errOut)
{
