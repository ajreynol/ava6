...
#ifndef AVA6__THEORY__BOOLEANS__THEORY_BOOL_REWRITER_H
#define AVA6__THEORY__BOOLEANS__THEORY_BOOL_REWRITER_H
...
#endif /* AVA6__THEORY__BOOLEANS__THEORY_BOOL_REWRITER_H */
