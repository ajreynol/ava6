...
#ifndef AVA6__THEORY__BOOLEANS__CIRCUIT_PROPAGATOR_H
#define AVA6__THEORY__BOOLEANS__CIRCUIT_PROPAGATOR_H
...
class CircuitPropagator : protected EnvObj
{
 public:
   ...
   */
  AVA6_WARN_UNUSED_RESULT TrustNode propagate();
...
#endif /* AVA6__THEORY__BOOLEANS__CIRCUIT_PROPAGATOR_H */
