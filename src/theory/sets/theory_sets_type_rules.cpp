...
TypeNode CardTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
...
TypeNode ComplementTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                            AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode UniverseSetTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                             AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
TypeNode UniverseSetTypeRule::computeType(AVA6_UNUSED NodeManager* nodeManager,
                                          TNode n,
                                          bool check,
                                          std::ostream* errOut)
{
...
TypeNode RelBinaryOperatorTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                   AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelationTableJoinTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                   AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
                                                ...
                                                std::ostream* errOut)
{
  ...
  if (check)
  {
    ...
    auto [aIndices, bIndices] = RelsUtils::splitTableJoinIndices(n);
...
TypeNode RelTransposeTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                              AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelTransClosureTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                 AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode JoinImageTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                           AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelIdenTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                         AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelationGroupTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                               AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelationAggregateTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                   AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode RelationProjectTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                 AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
