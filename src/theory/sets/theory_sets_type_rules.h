...
#ifndef AVA6__THEORY__SETS__THEORY_SETS_TYPE_RULES_H
#define AVA6__THEORY__SETS__THEORY_SETS_TYPE_RULES_H
...
#endif /* AVA6__THEORY__SETS__THEORY_SETS_TYPE_RULES_H */
