...
{
  throw LogicException("Set cardinality is not supported by the core solver");
}
void TheorySetsPrivate::ensureRelationsEnabled()
{
  throw LogicException("Relations are not supported by the core solver");
}
...
void TheorySetsPrivate::preRegisterTerm(TNode node)
{
  ...
  switch (node.getKind())
  {
    ...
    case Kind::RELATION_JOIN_IMAGE:
    {
      ...
      ava6::internal::Rational r(INT_MAX);
