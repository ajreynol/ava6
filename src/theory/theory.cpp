...
bool Theory::needsEqualityEngine(AVA6_UNUSED EeSetupInfo& esi)
{
...
void Theory::notifySharedTerm(AVA6_UNUSED TNode n)
{
  // do nothing
}
...
void Theory::computeRelevantTerms(AVA6_UNUSED std::set<Node>& termSet)
{
...
bool Theory::collectModelValues(AVA6_UNUSED TheoryModel* m,
                                AVA6_UNUSED const std::set<Node>& termSet)
{
  return true;
}
...
std::pair<bool, Node> Theory::entailmentCheck(AVA6_UNUSED TNode lit)
{
...
bool Theory::preCheck(AVA6_UNUSED Effort level) { return false; }

void Theory::postCheck(AVA6_UNUSED Effort level) {}

bool Theory::preNotifyFact(AVA6_UNUSED TNode atom,
                           AVA6_UNUSED bool polarity,
...
void Theory::notifyFact(AVA6_UNUSED TNode atom,
                        AVA6_UNUSED bool polarity,
                        AVA6_UNUSED TNode fact,
                        AVA6_UNUSED bool isInternal)
{
...
void Theory::preRegisterTerm(AVA6_UNUSED TNode node) {}
