 ...
 * calls into its ava6::internal::theory::OutputChannel, and it should only
 ...
 * proper management of ava6 components.
 */

#include "ava6_private.h"

#ifndef AVA6__THEORY__INTERRUPTED_H
#define AVA6__THEORY__INTERRUPTED_H
...
class Interrupted : public ava6::internal::Exception
{
}; /* class Interrupted */
...
#endif /* AVA6__THEORY__INTERRUPTED_H */
