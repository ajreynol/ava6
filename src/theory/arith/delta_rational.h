...
{
 private:
  ava6::internal::Rational c;
  ava6::internal::Rational k;

 public:
  DeltaRational() : c(0, 1), k(0, 1) {}
  DeltaRational(const ava6::internal::Rational& base) : c(base), k(0, 1) {}
  DeltaRational(const ava6::internal::Rational& base,
                const ava6::internal::Rational& coeff)
      : c(base), k(coeff)
  {
  }

  const ava6::internal::Rational& getInfinitesimalPart() const { return k; }

  const ava6::internal::Rational& getNoninfinitesimalPart() const { return c; }
  ...
  {
    ava6::internal::Rational tmpC = c + other.c;
    ava6::internal::Rational tmpK = k + other.k;
    return DeltaRational(tmpC, tmpK);
  }

  DeltaRational operator*(const Rational& a) const
  {
    ava6::internal::Rational tmpC = a * c;
    ava6::internal::Rational tmpK = a * k;
    return DeltaRational(tmpC, tmpK);
  }
  ...
  DeltaRational operator-(const DeltaRational& a) const
  {
    ava6::internal::Rational negOne(ava6::internal::Integer(-1));
  ...
  DeltaRational operator/(const Rational& a) const
  {
    ava6::internal::Rational tmpC = c / a;
    ava6::internal::Rational tmpK = k / a;
    return DeltaRational(tmpC, tmpK);
  }
  ...
  DeltaRational& operator*=(const ava6::internal::Rational& a)
  {
    c *= a;
    k *= a;
