...
#ifndef AVA6__THEORY__ARITH__ARITH_PROOF_UTILITIES_H
#define AVA6__THEORY__ARITH__ARITH_PROOF_UTILITIES_H
...
#endif /* AVA6__THEORY__ARITH__ARITH_PROOF_UTILITIES_H */
