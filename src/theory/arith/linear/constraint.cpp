...
void Constraint::setAssumption(AVA6_UNUSED bool nowInConflict)
{
...
void Constraint::impliedByUnate(NodeManager* nm,
                                ConstraintCP imp,
                                AVA6_UNUSED bool nowInConflict)
{
...
void Constraint::setInternalAssumption(AVA6_UNUSED bool nowInConflict)
{
...
void Constraint::setLiteral(Node n, AVA6_UNUSED Node nn)
{
