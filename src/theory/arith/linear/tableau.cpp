...
void Tableau::pivot(ArithVar oldBasic,
                    ArithVar newBasic,
 ...
 */
void Tableau::rowPivot(ArithVar basicOld,
                       ArithVar basicNew,
                       CoefficientChangeCallback& cb)
{
                     ...
                     const std::vector<ArithVar>& variables)
{
  ...
  CoefficientChangeCallback* cccb =
      static_cast<CoefficientChangeCallback*>(nep);
...
void Tableau::substitutePlusTimesConstant(ArithVar to,
                                          ArithVar from,
                                          const Rational& mult,
                                          CoefficientChangeCallback& cb)
{
