...
class SimplexDecisionProcedure : protected EnvObj
{
 protected:
  ...
  void shrinkInfeasFunc(TimerStat& timer,
                        ArithVar inf,
 ...
 protected:
  ...
  typedef std::unordered_map<std::pair<ArithVar, int>,
                             ArithVarVec,
  ...
  ArithVar find_basic_in_sgns(const sgn_table& sgns,
                              ArithVar col,
                              int sgn,
                              const DenseSet& m,
                              bool inside);

  sgn_table::const_iterator find_sgns(const sgn_table& sgns,
                                      ArithVar col,
                                      int sgn);
