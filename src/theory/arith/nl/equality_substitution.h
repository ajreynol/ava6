...
#ifndef AVA6__THEORY__ARITH__NL__EQUALITY_SUBSTITUTION_H
#define AVA6__THEORY__ARITH__NL__EQUALITY_SUBSTITUTION_H
...
#endif /* AVA6__THEORY__ARITH__NL__EQUALITY_SUBSTITUTION_H */
