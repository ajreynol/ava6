...
#ifndef AVA6__THEORY__ARITH__NL__EXT_THEORY_CALLBACK_H
#define AVA6__THEORY__ARITH__NL__EXT_THEORY_CALLBACK_H
...
#endif /* AVA6__THEORY__ARITH__NL__EXT_THEORY_CALLBACK_H */
