...
#ifndef AVA6__THEORY__ARITH__THEORY_ARITH_TYPE_RULES_H
#define AVA6__THEORY__ARITH__THEORY_ARITH_TYPE_RULES_H
...
#endif /* AVA6__THEORY__ARITH__THEORY_ARITH_TYPE_RULES_H */
