...
#ifndef AVA6__THEORY__THEORY_INFERENCE_H
#define AVA6__THEORY__THEORY_INFERENCE_H
...
class TheoryInference
{
 public:
   ...
   */
  virtual TrustNode processLemma(AVA6_UNUSED LemmaProperty& p)
  {
   ...
   */
  virtual Node processFact(AVA6_UNUSED std::vector<Node>& exp,
                           AVA6_UNUSED ProofGenerator*& pg)
  {
    return Node::null();
  }
