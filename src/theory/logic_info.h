...
#ifndef AVA6__LOGIC_INFO_H
#define AVA6__LOGIC_INFO_H
 ...
 * context for all operations in ava6.  Typically, when ava6's SolverEngine
 ...
 *
 * Most places in ava6 will only ever need to access a const reference to an
...
class AVA6_EXPORT LogicInfo
{
 ...
 private:
   ...
   * @throws ava6::internal::Exception if the theory is already registered.
   */
