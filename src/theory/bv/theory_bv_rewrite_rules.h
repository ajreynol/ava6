...
#ifndef AVA6__THEORY__BV__THEORY_BV_REWRITE_RULES_H
#define AVA6__THEORY__BV__THEORY_BV_REWRITE_RULES_H
...
inline std::ostream& operator<<(std::ostream& out, RewriteRuleId ruleId)
{
  switch (ruleId)
  {
    ...
    case UdivZero: out << "UdivZero"; return out;
...
class RewriteRule
{
  ...
  static inline Node apply(AVA6_UNUSED TNode node)
  {
    Unreachable();
 ...
 public:
  ...
  static inline bool applies(AVA6_UNUSED TNode node)
  {
    Unreachable();
    SuppressWrongNoReturnWarning;
  }
...
template <>
inline bool RewriteRule<EmptyRule>::applies(AVA6_UNUSED TNode node)
{
  return false;
}

template <>
inline Node RewriteRule<EmptyRule>::apply(TNode node)
{
