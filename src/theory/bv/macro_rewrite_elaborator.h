...
#ifndef AVA6__THEORY__BV__MACRO_REWRITE_ELABORATOR_H
#define AVA6__THEORY__BV__MACRO_REWRITE_ELABORATOR_H
...
#endif /* AVA6__THEORY__BV__MACRO_REWRITE_ELABORATOR_H */
