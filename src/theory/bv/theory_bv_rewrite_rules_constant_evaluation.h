...
#ifndef AVA6__THEORY__BV__THEORY_BV_REWRITE_RULES_CONSTANT_EVALUATION_H
#define AVA6__THEORY__BV__THEORY_BV_REWRITE_RULES_CONSTANT_EVALUATION_H
...
template <>
inline bool RewriteRule<EvalAnd>::applies(TNode node)
{
  Unreachable();
...
template <>
inline Node RewriteRule<EvalAnd>::apply(TNode node)
{
  Unreachable();
...
template <>
inline bool RewriteRule<EvalOr>::applies(TNode node)
{
  Unreachable();
...
template <>
inline Node RewriteRule<EvalOr>::apply(TNode node)
{
  Unreachable();
...
template <>
inline bool RewriteRule<EvalXor>::applies(TNode node)
{
  Unreachable();
...
template <>
inline Node RewriteRule<EvalXor>::apply(TNode node)
{
  Unreachable();
...
// }
template <>
inline bool RewriteRule<EvalNot>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_NOT && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalNot>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalMult>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_MULT && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalMult>::apply(TNode node)
{
...
// }
template <>
inline bool RewriteRule<EvalNeg>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_NEG && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalNeg>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalUdiv>::applies(TNode node)
{
  return utils::isBvConstTerm(node) && node.getKind() == Kind::BITVECTOR_UDIV;
}

template <>
inline Node RewriteRule<EvalUdiv>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalUrem>::applies(TNode node)
{
  return utils::isBvConstTerm(node) && node.getKind() == Kind::BITVECTOR_UREM;
}

template <>
inline Node RewriteRule<EvalUrem>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalShl>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_SHL && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalShl>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalLshr>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_LSHR && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalLshr>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalAshr>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_ASHR && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalAshr>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalUlt>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_ULT && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalUlt>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalUltBv>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalUltBv>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalSlt>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_SLT && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalSlt>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalSltBv>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalSltBv>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalITEBv>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalITEBv>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalUle>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_ULE && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalUle>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalSle>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_SLE && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalSle>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalExtract>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalExtract>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalConcat>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalConcat>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalSignExtend>::applies(TNode node)
{
...
template <>
inline Node RewriteRule<EvalSignExtend>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalEquals>::applies(TNode node)
{
  return (node.getKind() == Kind::EQUAL && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalEquals>::apply(TNode node)
{
...
template <>
inline bool RewriteRule<EvalComp>::applies(TNode node)
{
  return (node.getKind() == Kind::BITVECTOR_COMP && utils::isBvConstTerm(node));
}

template <>
inline Node RewriteRule<EvalComp>::apply(TNode node)
{
...
{
  Trace("bv-rewrite") << "RewriteRule<EvalEagerAtom>(" << node << ")"
                      << std::endl;
  return node[0];
}
}  // namespace bv
