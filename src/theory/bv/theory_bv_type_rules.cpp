...
TypeNode BitVectorConstantTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                   AVA6_UNUSED TNode n)
{
...
TypeNode BitVectorConcatTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                 AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode BitVectorITETypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                              AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode BitVectorRepeatTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                 AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode BitVectorExtendTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                                 AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
