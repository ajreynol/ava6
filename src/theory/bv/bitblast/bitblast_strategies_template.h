...
#ifndef AVA6__THEORY__BV__BITBLAST__BITBLAST_STRATEGIES_TEMPLATE_H
#define AVA6__THEORY__BV__BITBLAST__BITBLAST_STRATEGIES_TEMPLATE_H
...
template <class T>
T UndefinedAtomBBStrategy(TNode node, AVA6_UNUSED TBitblaster<T>* bb)
{
  Trace("bitvector")
...
template <class T>
T DefaultUgtBB(TNode node, AVA6_UNUSED TBitblaster<T>* bb)
{
  Trace("bitvector-bb") << "Bitblasting node " << node << "\n";
  // should be rewritten
  Unimplemented();
...
template <class T>
T DefaultUgeBB(TNode node, AVA6_UNUSED TBitblaster<T>* bb)
{
  Trace("bitvector-bb") << "Bitblasting node " << node << "\n";
  // should be rewritten
  Unimplemented();
...
template <class T>
T DefaultSgtBB(TNode node, AVA6_UNUSED TBitblaster<T>* bb)
{
  Trace("bitvector-bb") << "Bitblasting node " << node << "\n";
  // should be rewritten
  Unimplemented();
...
template <class T>
T DefaultSgeBB(TNode node, AVA6_UNUSED TBitblaster<T>* bb)
{
  Trace("bitvector-bb") << "Bitblasting node " << node << "\n";
  // should be rewritten
  Unimplemented();
...
void UndefinedTermBBStrategy(TNode node,
                             AVA6_UNUSED std::vector<T>& bits,
                             AVA6_UNUSED TBitblaster<T>* bb)
{
...
void DefaultZeroExtendBB(TNode node,
                         AVA6_UNUSED std::vector<T>& res_bits,
                         AVA6_UNUSED TBitblaster<T>* bb)
{
