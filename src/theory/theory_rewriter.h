...
#ifndef AVA6__THEORY__THEORY_REWRITER_H
#define AVA6__THEORY__THEORY_REWRITER_H
...
class TheoryRewriter
{
 public:
   ...
   */
  virtual void registerRewrites(AVA6_UNUSED Rewriter* rewriter) {}
...
#endif /* AVA6__THEORY__THEORY_REWRITER_H */
