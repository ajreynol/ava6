...
#ifndef AVA6__THEORY__THEORY_H
#define AVA6__THEORY__THEORY_H
...
class Theory : protected EnvObj
{
 ...
 public:
   ...
   * model construction.
   */
  virtual Node getCandidateModelValue(AVA6_UNUSED TNode var)
  {
    return Node::null();
  }

  /** T-propagate new literal assignments in the current context. */
  virtual void propagate(AVA6_UNUSED Effort level = EFFORT_FULL) {}
   ...
   */
  virtual void postProcessModel(AVA6_UNUSED TheoryModel* m) {}
   ...
   */
  virtual TrustNode ppRewrite(AVA6_UNUSED TNode n,
                              AVA6_UNUSED std::vector<SkolemLemma>& lems)
  {
    return TrustNode::null();
  }
  /**
   ...
   * calculus works in "original forms" and not "witness forms".
   */
  virtual TrustNode ppStaticRewrite(AVA6_UNUSED TNode n)
  {
    return TrustNode::null();
  }
...
inline std::ostream& operator<<(std::ostream& out,
                                const ava6::internal::theory::Theory& theory)
{
