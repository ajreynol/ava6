...
bool ExtTheoryCallback::getCurrentSubstitution(
    AVA6_UNUSED int effort,
    AVA6_UNUSED const std::vector<Node>& vars,
    AVA6_UNUSED std::vector<Node>& subs,
    AVA6_UNUSED std::map<Node, std::vector<Node> >& exp)
{
  return false;
}
bool ExtTheoryCallback::isExtfReduced(AVA6_UNUSED int effort,
                                      Node n,
                                      AVA6_UNUSED Node on,
...
bool ExtTheoryCallback::getReduction(AVA6_UNUSED int effort,
                                     AVA6_UNUSED Node n,
                                     AVA6_UNUSED Node& nr,
                                     AVA6_UNUSED bool& isSatDep)
{
  return false;
}
