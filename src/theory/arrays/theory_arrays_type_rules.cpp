...
TypeNode ArraySelectTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                             AVA6_UNUSED TNode n)
{
...
TypeNode ArrayStoreTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                            AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
bool ArrayStoreTypeRule::computeIsConst(AVA6_UNUSED NodeManager* nodeManager,
                                        TNode n)
{
...
TypeNode ArrayEqRangeTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                              AVA6_UNUSED TNode n)
{
