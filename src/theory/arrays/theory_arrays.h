...
#ifndef AVA6__THEORY__ARRAYS__THEORY_ARRAYS_H
#define AVA6__THEORY__ARRAYS__THEORY_ARRAYS_H
...
class TheoryArrays : public Theory
{
 ...
 private:
  ...
  {
   public:
    bool notify(AVA6_UNUSED TNode propagation) { return true; }
    void notify(AVA6_UNUSED TNode t1, AVA6_UNUSED TNode t2) {}
  };
...
#endif /* AVA6__THEORY__ARRAYS__THEORY_ARRAYS_H */
