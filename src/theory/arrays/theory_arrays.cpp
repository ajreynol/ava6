...
void TheoryArrays::checkWeakEquiv(AVA6_UNUSED bool arraysMerged)
{
...
void TheoryArrays::checkPair(TNode r1, TNode r2)
{
  ...
  if (r1[0] != r2[0])
  {
    ...
    if (!AVA6_EQUAL(r1[0].getType(), r2[0].getType())
  ...
  switch (eqStatusDomain)
  {
    ...
    case EQUALITY_FALSE_AND_PROPAGATED:
      ...
      DebugUnhandled();
      break;
    case EQUALITY_FALSE: AVA6_FALLTHROUGH;
...
void TheoryArrays::computeCareGraph()
{
  if (d_sharedArrays.size() > 0)
  {
    ...
    for (; it1 != iend; ++it1)
    {
      ...
      {
        if (!AVA6_EQUAL((*it1).getType(), (*it2).getType()))
        {
          continue;
        }
