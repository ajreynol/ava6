...
#define AVA6_FOR_EACH_THEORY                                               \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_BUILTIN)   \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_BOOL)      \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_UF)        \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_ARITH)     \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_BV)        \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_ARRAYS)    \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_DATATYPES) \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_SETS)      \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_STRINGS)   \
  AVA6_FOR_EACH_THEORY_STATEMENT(ava6::internal::theory::THEORY_QUANTIFIERS)
...
void TheoryEngine::finishInit()
{
  ...
  // using the AVA6_FOR_EACH_THEORY_STATEMENT macro. -AJR
  std::vector<theory::Theory*> paraTheories;
#ifdef AVA6_FOR_EACH_THEORY_STATEMENT
#undef AVA6_FOR_EACH_THEORY_STATEMENT
#endif
#define AVA6_FOR_EACH_THEORY_STATEMENT(THEORY)                               \
...
bool TheoryEngine::isLegalElimination(TNode x, TNode val)
{
  ...
  if (!AVA6_EQUAL(val.getType(), x.getType()))
  {
    return false;
  }
...
struct AtomsCollect
{
 ...
 public:
  ...
  bool alreadyVisited(TNode current, AVA6_UNUSED TNode parent)
  {
  ...
  void visit(TNode current, AVA6_UNUSED TNode parent)
  {
  ...
  void start(AVA6_UNUSED TNode node) {}
  void done(AVA6_UNUSED TNode node) {}
