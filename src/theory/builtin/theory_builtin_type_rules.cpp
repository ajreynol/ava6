...
TypeNode EqualityTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
...
TypeNode SExprTypeRule::preComputeType(NodeManager* nm, AVA6_UNUSED TNode n)
{
  return nm->sExprType();
}
...
TypeNode WitnessTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                         AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
...
TypeNode TypeOfTypeRule::preComputeType(AVA6_UNUSED NodeManager* nm,
                                        AVA6_UNUSED TNode n)
{
  return TypeNode::null();
}
