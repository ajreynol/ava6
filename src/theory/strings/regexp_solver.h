...
#ifndef AVA6__THEORY__STRINGS__REGEXP_SOLVER_H
#define AVA6__THEORY__STRINGS__REGEXP_SOLVER_H
...
class RegExpSolver : protected EnvObj
{
 ...
 private:
  ...
  ava6::internal::String getHeadConst(Node x);
...
#endif /* AVA6__THEORY__STRINGS__THEORY_STRINGS_H */
