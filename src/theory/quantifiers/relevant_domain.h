...
#ifndef AVA6__THEORY__QUANTIFIERS__RELEVANT_DOMAIN_H
#define AVA6__THEORY__QUANTIFIERS__RELEVANT_DOMAIN_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__RELEVANT_DOMAIN_H */
