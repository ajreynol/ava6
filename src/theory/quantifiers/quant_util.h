...
#ifndef AVA6__THEORY__QUANT_UTIL_H
#define AVA6__THEORY__QUANT_UTIL_H
...
class QuantifiersUtil : protected EnvObj
{
 public:
   ...
   */
  virtual bool reset(AVA6_UNUSED Theory::Effort e) { return true; }
...
#endif /* AVA6__THEORY__QUANT_UTIL_H */
