...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_STATE_H
#define AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_STATE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_STATE_H */
