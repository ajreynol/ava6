...
void InstStrategyEnum::reset_round(AVA6_UNUSED Theory::Effort e) {}
void InstStrategyEnum::check(AVA6_UNUSED Theory::Effort e, QEffort quant_e)
{
  bool doCheck = false;
