...
template <typename T>
static Ava6ostream& operator<<(Ava6ostream& out, const std::vector<T>& v)
{
  out << "[ ";
...
static void traceMaskedVector(AVA6_UNUSED const char* trace,
                              const char* name,
...
class TermTupleEnumeratorBase : public TermTupleEnumeratorInterface
{
 ...
 protected:
  ...
  AVA6_WARN_UNUSED_RESULT virtual Node getTerm(size_t variableIx,
                                               size_t term_index) = 0;
};
