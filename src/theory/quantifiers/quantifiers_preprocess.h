...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_PREPROCESS_H
#define AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_PREPROCESS_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_REWRITER_H */
