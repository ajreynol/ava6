...
#ifndef AVA6__THEORY__QUANTIFIERS__THEORY_QUANTIFIERS_TYPE_RULES_H
#define AVA6__THEORY__QUANTIFIERS__THEORY_QUANTIFIERS_TYPE_RULES_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__THEORY_QUANTIFIERS_TYPE_RULES_H */
