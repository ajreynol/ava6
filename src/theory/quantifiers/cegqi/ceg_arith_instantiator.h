...
#ifndef AVA6__THEORY__QUANTIFIERS__CEG_ARITH_INSTANTIATOR_H
#define AVA6__THEORY__QUANTIFIERS__CEG_ARITH_INSTANTIATOR_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__CEG_ARITH_INSTANTIATOR_H */
