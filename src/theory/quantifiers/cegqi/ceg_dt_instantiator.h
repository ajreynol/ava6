...
#ifndef AVA6__THEORY__QUANTIFIERS__CEG_DT_INSTANTIATOR_H
#define AVA6__THEORY__QUANTIFIERS__CEG_DT_INSTANTIATOR_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__CEG_DT_INSTANTIATOR_H */
