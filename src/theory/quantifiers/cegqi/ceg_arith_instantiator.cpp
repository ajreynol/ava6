...
void ArithInstantiator::reset(AVA6_UNUSED CegInstantiator* ci,
...
bool ArithInstantiator::hasProcessEquality(AVA6_UNUSED CegInstantiator* ci,
                                           AVA6_UNUSED SolvedForm& sf,
                                           AVA6_UNUSED Node pv,
                                           AVA6_UNUSED CegInstEffort effort)
{
...
bool ArithInstantiator::hasProcessAssertion(AVA6_UNUSED CegInstantiator* ci,
                                            AVA6_UNUSED SolvedForm& sf,
                                            AVA6_UNUSED Node pv,
...
Node ArithInstantiator::hasProcessAssertion(AVA6_UNUSED CegInstantiator* ci,
                                            AVA6_UNUSED SolvedForm& sf,
                                            AVA6_UNUSED Node pv,
                                            Node lit,
                                            AVA6_UNUSED CegInstEffort effort)
...
CegTermType ArithInstantiator::solve_arith(AVA6_UNUSED CegInstantiator* ci,
                                           Node pv,
                                           Node atom,
                                           Node& veq_c,
                                           Node& val,
