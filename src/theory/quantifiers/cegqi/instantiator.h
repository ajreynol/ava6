...
#ifndef AVA6__THEORY__QUANTIFIERS__INSTANTIATOR_H
#define AVA6__THEORY__QUANTIFIERS__INSTANTIATOR_H
...
class Instantiator : protected EnvObj
{
 public:
   ...
   */
  virtual void reset(AVA6_UNUSED CegInstantiator* ci,
   ...
   * processEqualTerms.
   */
  virtual bool hasProcessEqualTerm(AVA6_UNUSED CegInstantiator* ci,
                                   AVA6_UNUSED SolvedForm& sf,
                                   AVA6_UNUSED Node pv,
                                   AVA6_UNUSED CegInstEffort effort)
  {
   ...
   * CegInstantiator::constructInstantiationInc.
   */
  virtual bool processEqualTerms(AVA6_UNUSED CegInstantiator* ci,
                                 AVA6_UNUSED SolvedForm& sf,
                                 AVA6_UNUSED Node pv,
                                 AVA6_UNUSED std::vector<Node>& eqc,
                                 AVA6_UNUSED CegInstEffort effort)
  {
    return false;
  }
  ...
  virtual bool hasProcessEquality(AVA6_UNUSED CegInstantiator* ci,
                                  AVA6_UNUSED SolvedForm& sf,
                                  AVA6_UNUSED Node pv,
                                  AVA6_UNUSED CegInstEffort effort)
  {
  ...
  virtual bool processEquality(
      AVA6_UNUSED CegInstantiator* ci,
      AVA6_UNUSED SolvedForm& sf,
      AVA6_UNUSED Node pv,
      AVA6_UNUSED std::vector<TermProperties>& term_props,
      AVA6_UNUSED std::vector<Node>& terms,
      AVA6_UNUSED CegInstEffort effort)
  {
    return false;
  }
  ...
  virtual bool hasProcessAssertion(AVA6_UNUSED CegInstantiator* ci,
                                   AVA6_UNUSED SolvedForm& sf,
                                   AVA6_UNUSED Node pv,
                                   AVA6_UNUSED CegInstEffort effort)
  {
   ...
   */
  virtual Node hasProcessAssertion(AVA6_UNUSED CegInstantiator* ci,
                                   AVA6_UNUSED SolvedForm& sf,
                                   AVA6_UNUSED Node pv,
                                   AVA6_UNUSED Node lit,
                                   AVA6_UNUSED CegInstEffort effort)
  {
    return Node::null();
  }
   ...
   *  CegInstantiator::constructInstantiationInc.
   */
  virtual bool processAssertion(AVA6_UNUSED CegInstantiator* ci,
                                AVA6_UNUSED SolvedForm& sf,
                                AVA6_UNUSED Node pv,
                                AVA6_UNUSED Node lit,
                                AVA6_UNUSED Node alit,
                                AVA6_UNUSED CegInstEffort effort)
  {
    return false;
  }
   ...
   * CegInstantiator::constructInstantiationInc.
   */
  virtual bool processAssertions(AVA6_UNUSED CegInstantiator* ci,
                                 AVA6_UNUSED SolvedForm& sf,
                                 AVA6_UNUSED Node pv,
                                 AVA6_UNUSED CegInstEffort effort)
  {
   ...
   */
  virtual bool useModelValue(AVA6_UNUSED CegInstantiator* ci,
                             AVA6_UNUSED SolvedForm& sf,
                             AVA6_UNUSED Node pv,
                             CegInstEffort effort)
  {
  ...
  virtual bool allowModelValue(AVA6_UNUSED CegInstantiator* ci,
                               AVA6_UNUSED SolvedForm& sf,
                               AVA6_UNUSED Node pv,
                               AVA6_UNUSED CegInstEffort effort)
  {
...
class ModelValueInstantiator : public Instantiator
{
 public:
  ...
  bool useModelValue(AVA6_UNUSED CegInstantiator* ci,
                     AVA6_UNUSED SolvedForm& sf,
                     AVA6_UNUSED Node pv,
                     AVA6_UNUSED CegInstEffort effort) override
  {
    return true;
  }
...
class InstantiatorPreprocess
{
 public:
  ...
  virtual void registerCounterexampleLemma(
      AVA6_UNUSED Node lem,
      AVA6_UNUSED std::vector<Node>& ceVars,
      AVA6_UNUSED std::vector<Node>& auxLems)
  {
  }
};
