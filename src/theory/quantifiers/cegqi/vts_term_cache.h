...
#ifndef AVA6__THEORY__QUANTIFIERS__CEGQI__VTS_TERM_CACHE_H
#define AVA6__THEORY__QUANTIFIERS__CEGQI__VTS_TERM_CACHE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__CEGQI__VTS_TERM_CACHE_H */
