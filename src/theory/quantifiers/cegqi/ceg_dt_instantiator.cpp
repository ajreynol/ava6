...
void DtInstantiator::reset(AVA6_UNUSED CegInstantiator* ci,
...
bool DtInstantiator::hasProcessEqualTerm(AVA6_UNUSED CegInstantiator* ci,
                                         AVA6_UNUSED SolvedForm& sf,
                                         AVA6_UNUSED Node pv,
                                         AVA6_UNUSED CegInstEffort effort)
{
...
bool DtInstantiator::hasProcessEquality(AVA6_UNUSED CegInstantiator* ci,
                                        AVA6_UNUSED SolvedForm& sf,
                                        AVA6_UNUSED Node pv,
                                        AVA6_UNUSED CegInstEffort effort)
{
