...
#ifndef AVA6__THEORY__QUANTIFIERS__ENTAILMENT_CHECK_H
#define AVA6__THEORY__QUANTIFIERS__ENTAILMENT_CHECK_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__ENTAILMENT_CHECK_H */
