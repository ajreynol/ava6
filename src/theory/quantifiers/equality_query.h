...
#ifndef AVA6__THEORY__QUANTIFIERS_EQUALITY_QUERY_H
#define AVA6__THEORY__QUANTIFIERS_EQUALITY_QUERY_H
...
class EqualityQuery : public QuantifiersUtil
{
 public:
  ...
  void registerQuantifier(AVA6_UNUSED Node q) override {}
  /** identify */
...
#endif /* AVA6__THEORY__QUANTIFIERS_EQUALITY_QUERY_H */
