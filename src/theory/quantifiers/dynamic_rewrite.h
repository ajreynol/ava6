...
#ifndef AVA6__THEORY__QUANTIFIERS__DYNAMIC_REWRITER_H
#define AVA6__THEORY__QUANTIFIERS__DYNAMIC_REWRITER_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__DYNAMIC_REWRITER_H */
