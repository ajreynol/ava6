...
#ifndef AVA6__THEORY__QUANTIFIERS__INSTANTIATION_ENGINE_H
#define AVA6__THEORY__QUANTIFIERS__INSTANTIATION_ENGINE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__INSTANTIATION_ENGINE_H */
