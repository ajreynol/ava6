...
#ifndef AVA6__THEORY__QUANTIFIERS__TRIGGER_H
#define AVA6__THEORY__QUANTIFIERS__TRIGGER_H
 ...
 *
 * This class encapsulates all implementations of E-matching in ava6.
...
#endif /* AVA6__THEORY__QUANTIFIERS__TRIGGER_H */
