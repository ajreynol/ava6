...
#ifndef AVA6__THEORY__QUANTIFIERS__CANDIDATE_GENERATOR_H
#define AVA6__THEORY__QUANTIFIERS__CANDIDATE_GENERATOR_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__CANDIDATE_GENERATOR_H */
