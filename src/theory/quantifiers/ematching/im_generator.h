...
#ifndef AVA6__THEORY__QUANTIFIERS__IM_GENERATOR_H
#define AVA6__THEORY__QUANTIFIERS__IM_GENERATOR_H
...
class IMGenerator : protected EnvObj
{
 public:
   ...
   */
  virtual bool reset(AVA6_UNUSED Node eqc) { return true; }
  /** Get the next match.
   *
   ...
   */
  virtual int getNextMatch(AVA6_UNUSED InstMatch& m) { return 0; }
  /** add instantiations
   *
   ...
   */
  virtual uint64_t addInstantiations(AVA6_UNUSED InstMatch& m) { return 0; }
  /** get active score
   *
