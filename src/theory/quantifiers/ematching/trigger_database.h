...
#ifndef AVA6__THEORY__QUANTIFIERS__TRIGGER_DATABASE_H
#define AVA6__THEORY__QUANTIFIERS__TRIGGER_DATABASE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__TRIGGER_DATABASE_H */
