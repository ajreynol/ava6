...
#ifndef AVA6__THEORY__QUANTIFIERS__INST_MATCH_GENERATOR_MULTI_LINEAR_H
#define AVA6__THEORY__QUANTIFIERS__INST_MATCH_GENERATOR_MULTI_LINEAR_H
 ...
 * InstMatchGenerators.
 *
 * ava6 employs techniques that ensure that the number of instantiations
