...
using namespace ava6::internal::theory::quantifiers::inst;
...
void InstStrategyAutoGenTriggers::processResetInstantiationRound(
    AVA6_UNUSED Theory::Effort effort)
{
...
InstStrategyStatus InstStrategyAutoGenTriggers::process(
    Node f, AVA6_UNUSED Theory::Effort effort, int e)
{
