...
#ifndef AVA6__THEORY__QUANTIFIERS__MODEL_BUILDER_H
#define AVA6__THEORY__QUANTIFIERS__MODEL_BUILDER_H
...
class QModelBuilder : public TheoryEngineModelBuilder
{
 ...
 public:
  ...
  //  >0 : success
  //  <0 : failed
  virtual int doExhaustiveInstantiation(AVA6_UNUSED FirstOrderModel* fm,
                                        AVA6_UNUSED Node f,
...
#endif /* AVA6__THEORY__QUANTIFIERS__MODEL_BUILDER_H */
