...
QuantifiersModule::QEffort ModelEngine::needsModel(AVA6_UNUSED Theory::Effort e)
{
  {
...
void ModelEngine::reset_round(AVA6_UNUSED Theory::Effort e)
{
  d_incomplete_check = true;
}
void ModelEngine::check(AVA6_UNUSED Theory::Effort e, QEffort quant_e)
{
  bool doCheck = false;
  ...
  if (doCheck)
  {
    ...
    if (addedLemmas == 0)
    {
      ...
      // ava6 will answer SAT or unknown
