...
#ifndef AVA6__THEORY__QUANTIFIERS__FULL_MODEL_CHECK_H
#define AVA6__THEORY__QUANTIFIERS__FULL_MODEL_CHECK_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__FULL_MODEL_CHECK_H */
