...
#ifndef AVA6__THEORY__QUANTIFIERS__EXTENDED_REWRITE_H
#define AVA6__THEORY__QUANTIFIERS__EXTENDED_REWRITE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__EXTENDED_REWRITE_H */
