...
#ifndef AVA6__THEORY__QUANTIFIERS__HO_TERM_DATABASE_H
#define AVA6__THEORY__QUANTIFIERS__HO_TERM_DATABASE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__HO_TERM_DATABASE_H */
