...
#ifndef AVA6__THEORY__QUANTIFIERS__INST_STRATEGY_MBQI_H
#define AVA6__THEORY__QUANTIFIERS__INST_STRATEGY_MBQI_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__INST_STRATEGY_MBQI_H */
