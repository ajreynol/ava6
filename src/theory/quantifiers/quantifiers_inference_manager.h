...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_INFERENCE_MANAGER_H
#define AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_INFERENCE_MANAGER_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_INFERENCE_MANAGER_H */
