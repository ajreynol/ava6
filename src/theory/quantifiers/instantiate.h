...
#ifndef AVA6__THEORY__QUANTIFIERS__INSTANTIATE_H
#define AVA6__THEORY__QUANTIFIERS__INSTANTIATE_H
...
class Instantiate : public QuantifiersUtil
{
 ...
 public:
   ...
   *
   * Returns true if and only if the instantiation was already added.
   */
 ...
 private:
   ...
   * for debugging and reporting instantiations.
   */
...
#endif /* AVA6__THEORY__QUANTIFIERS__INSTANTIATE_H */
