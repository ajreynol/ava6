...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANT_BOUND_INFERENCE_H
#define AVA6__THEORY__QUANTIFIERS__QUANT_BOUND_INFERENCE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__QUANT_BOUND_INFERENCE_H */
