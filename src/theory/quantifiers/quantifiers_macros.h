...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_MACROS_H
#define AVA6__THEORY__QUANTIFIERS__QUANTIFIERS_MACROS_H
...
#endif /*AVA6__THEORY__QUANTIFIERS__QUANTIFIER_MACROS_H */
