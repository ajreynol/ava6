...
#ifndef AVA6__THEORY__QUANTIFIERS__INST_MATCH_TRIE_H
#define AVA6__THEORY__QUANTIFIERS__INST_MATCH_TRIE_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__INST_MATCH_TRIE_H */
