...
#ifndef AVA6__FIRST_ORDER_MODEL_H
#define AVA6__FIRST_ORDER_MODEL_H
...
class FirstOrderModel : protected EnvObj
{
 ...
 protected:
  ...
  virtual void processInitializeModelForTerm(AVA6_UNUSED Node n) {}
  /** process initialize quantifier */
  virtual void processInitializeQuantifier(AVA6_UNUSED Node q) {}
  /** process initialize */
  virtual void processInitialize(AVA6_UNUSED bool ispre) {}
...
#endif /* AVA6__FIRST_ORDER_MODEL_H */
