...
#ifndef AVA6__THEORY__QUANTIFIERS__IEVAL__INST_EVALUATOR_MANAGER_H
#define AVA6__THEORY__QUANTIFIERS__IEVAL__INST_EVALUATOR_MANAGER_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__IEVAL__INST_EVALUATOR_MANAGER_H */
