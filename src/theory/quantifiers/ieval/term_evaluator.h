...
#ifndef AVA6__THEORY__QUANTIFIERS__IEVAL__TERM_EVALUATOR_H
#define AVA6__THEORY__QUANTIFIERS__IEVAL__TERM_EVALUATOR_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__IEVAL__TERM_EVALUATOR_CALLBACK_H */
