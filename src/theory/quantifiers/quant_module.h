...
#ifndef AVA6__THEORY__QUANTIFIERS__QUANT_MODULE_H
#define AVA6__THEORY__QUANTIFIERS__QUANT_MODULE_H
...
class QuantifiersModule : protected EnvObj
{
 ...
 public:
   ...
   */
  virtual void reset_round(AVA6_UNUSED Theory::Effort e) {}
  /** Check.
   *
   ...
   */
  virtual bool checkComplete(AVA6_UNUSED IncompleteId& incId) { return true; }
   ...
   */
  virtual bool checkCompleteFor(AVA6_UNUSED Node q) { return false; }
  /** Check ownership
   *
   ...
   */
  virtual void checkOwnership(AVA6_UNUSED Node q) {}
  /** Register quantifier
   *
   ...
   */
  virtual void registerQuantifier(AVA6_UNUSED Node q) {}
   ...
   */
  virtual void preRegisterQuantifier(AVA6_UNUSED Node q) {}
  /** Assert node.
   *
   * Called when a quantified formula q is asserted to the quantifiers theory
   */
  virtual void assertNode(AVA6_UNUSED Node q) {}
  /** notify preprocessed assertion */
  virtual void ppNotifyAssertions(
      AVA6_UNUSED const std::vector<Node>& assertions)
  {
  }
  /**
...
#endif /* AVA6__THEORY__QUANTIFIERS__QUANT_MODULE_H */
