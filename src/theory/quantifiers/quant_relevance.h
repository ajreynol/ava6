...
#ifndef AVA6__THEORY__QUANT_RELEVANCE_H
#define AVA6__THEORY__QUANT_RELEVANCE_H
...
class QuantRelevance : public QuantifiersUtil
{
 public:
  ...
  ~QuantRelevance() {}
  /** reset */
  bool reset(AVA6_UNUSED Theory::Effort e) override { return true; }
  /** register quantifier */
...
#endif /* AVA6__THEORY__QUANT_RELEVANCE_H */
