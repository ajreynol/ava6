...
#ifndef AVA6__THEORY__QUANTIFIERS__TERM_ENUMERATION_H
#define AVA6__THEORY__QUANTIFIERS__TERM_ENUMERATION_H
...
#endif /* AVA6__THEORY__QUANTIFIERS__TERM_ENUMERATION_H */
