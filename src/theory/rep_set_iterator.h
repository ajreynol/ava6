...
#ifndef AVA6__THEORY__REP_SET_ITERATOR_H
#define AVA6__THEORY__REP_SET_ITERATOR_H
...
class RepBoundExt
{
 public:
   ...
   */
  virtual bool resetIndex(AVA6_UNUSED RepSetIterator* rsi,
                          AVA6_UNUSED Node owner,
                          AVA6_UNUSED size_t i,
                          AVA6_UNUSED bool initial,
                          AVA6_UNUSED std::vector<Node>& elements)
  {
    return true;
  }
   ...
   * for type tn.
   */
  virtual bool initializeRepresentativesForType(AVA6_UNUSED TypeNode tn)
  {
    return false;
  }
  /** get variable order
   ...
   * variable order.
   */
  virtual bool getVariableOrder(AVA6_UNUSED Node owner,
                                AVA6_UNUSED std::vector<size_t>& varOrder)
  {
    return false;
  }
};
