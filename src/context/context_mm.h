...
#ifndef AVA6__CONTEXT__CONTEXT_MM_H
#define AVA6__CONTEXT__CONTEXT_MM_H

#ifndef AVA6_DEBUG_CONTEXT_MEMORY_MANAGER
#include <deque>
#endif
 ...
 *
 */
class AVA6_EXPORT ContextMemoryManager
{
  /**
...
#else /* AVA6_DEBUG_CONTEXT_MEMORY_MANAGER */
...
#endif /* AVA6_DEBUG_CONTEXT_MEMORY_MANAGER */
...
class ContextMemoryAllocator
{
 ...
 public:
  ...
  void deallocate(AVA6_UNUSED T* p, AVA6_UNUSED size_t n) const
  {
    /* no explicit delete */
  }
...
#endif /* AVA6__CONTEXT__CONTEXT_MM_H */
