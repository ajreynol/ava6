...
#ifndef AVA6__CONTEXT__CDHASHMAP_H
#define AVA6__CONTEXT__CDHASHMAP_H
...
class CDHashMap : public ContextObj
{
  ...
  ContextObj* save(AVA6_UNUSED ContextMemoryManager* pCMM) override
  {
    Unreachable();
  ...
  void restore(AVA6_UNUSED ContextObj* data) override { Unreachable(); }
...
#endif /* AVA6__CONTEXT__CDHASHMAP_H */
