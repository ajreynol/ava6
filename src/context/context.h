...
#ifndef AVA6__CONTEXT__CONTEXT_H
#define AVA6__CONTEXT__CONTEXT_H
...
class Scope
{
 ...
 public:
  ...
  static void operator delete(AVA6_UNUSED void* pMem,
                              AVA6_UNUSED ContextMemoryManager* pCMM)
  {
  }
  static void operator delete(AVA6_UNUSED void* pMem) {}
...
#endif /* AVA6__CONTEXT__CONTEXT_H */
