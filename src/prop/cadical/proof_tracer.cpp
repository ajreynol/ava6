...
namespace ava6::internal::prop::cadical {
 ...
 * order different from the normalized conclusion expected by ava6.
 *
...
void ProofTracer::add_original_clause(uint64_t clause_id,
                                      AVA6_UNUSED bool redundant,
                                      const std::vector<int>& clause,
                                      AVA6_UNUSED bool restored)
{
  ClauseType ctype =
...
void ProofTracer::add_derived_clause(AVA6_UNUSED uint64_t clause_id,
                                     bool redundant,
                                     const std::vector<int>& clause,
...
void ProofTracer::conclude_unsat(AVA6_UNUSED CaDiCaL::ConclusionType type,
