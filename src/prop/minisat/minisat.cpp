 ...
 * SAT Solver.
 *
 * Implementation of the minisat interface for ava6.
 */
...
{
  // Copy options from ava6 options structure into minisat, as appropriate
...
namespace ava6::internal {
template <>
prop::SatLiteral toSatLiteral<ava6::internal::Minisat::Solver>(
...
template <>
void toSatClause<ava6::internal::Minisat::Solver>(
    const ava6::internal::Minisat::Solver::TClause& minisat_cl,
