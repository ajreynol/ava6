...
#ifndef AVA6__SMT__ENV_H
#define AVA6__SMT__ENV_H
...
class Env
{
 ...
 public:
   ...
   * option. Otherwise, a null stream (`ava6::internal::null_os`) is returned.
   */
   ...
   * a null stream (`ava6::internal::null_os`) is returned. The user of this
   ...
   * Otherwise, a null stream (`ava6::internal::null_os`) is returned.
   */
