...
#ifndef AVA6__SMT__PROOF_LOGGER_H
#define AVA6__SMT__PROOF_LOGGER_H
...
class ProofLogger : protected EnvObj
{
 public:
  ...
  virtual void logCnfPreprocessInputs(
      AVA6_UNUSED const std::vector<Node>& inputs)
  {
  }
  /**
  ...
  virtual void logCnfPreprocessInputProofs(
      AVA6_UNUSED std::vector<std::shared_ptr<ProofNode>>& pfns)
  {
  }
  /**
   ...
   */
  virtual void logTheoryLemma(AVA6_UNUSED const Node& n) {}
  /**
   ...
   */
  virtual void logTheoryLemmaProof(AVA6_UNUSED std::shared_ptr<ProofNode>& pfn)
  {
  }
  /**
  ...
  virtual void logSatRefutationProof(
      AVA6_UNUSED std::shared_ptr<ProofNode>& pfn)
  {
  }
};
...
#endif /* AVA6__PROOF__PROOF_LOGGER_H */
