...
#ifndef AVA6__UTIL__STATISTICS_STATS_H
#define AVA6__UTIL__STATISTICS_STATS_H
 ...
 *
 * To convert to the API representation in `ava6::Stat`, `T` can only be one
 * of the types accepted by the `ava6::Stat` constructors (or be implicitly
...
class TimerStat
{
 public:
  ...
  using CodeTimer = ava6::internal::CodeTimer;
  /** Allow access to private constructor */
  friend class StatisticsRegistry;
  /** Value stored for this statistic */
