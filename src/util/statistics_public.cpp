...
{
  reg.registerHistogram<TypeConstant>("ava6::CONSTANT", false);
  reg.registerHistogram<TypeConstant>("ava6::VARIABLE", false);
  reg.registerHistogram<ava6::Kind>("ava6::TERM", false);
