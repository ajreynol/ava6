...
#ifndef AVA6__UTIL__STRING_H
#define AVA6__UTIL__STRING_H
...
class String
{
 ...
 public:
   ...
   *
   * Internally, a ava6::internal::String is represented by a vector of unsigned
   ...
   * ava6::internal::String correspond one-to-one with the input string.
   */
  String() = default;
   ...
   *    ava6::internal::String( s ).toString() = s.
   */
...
struct StringHashFunction
{
  size_t operator()(const ava6::internal::String& s) const;
}; /* struct StringHashFunction */
