...
#ifndef AVA6__UTIL__INTEGER_GMP_H
#define AVA6__UTIL__INTEGER_GMP_H
...
class Integer
{
  friend class ava6::internal::Rational;
 ...
 public:
   ...
   * Uses the ava6 Random singleton.
   */
...
namespace std {
template <>
struct hash<ava6::internal::Integer>
{
  size_t operator()(const ava6::internal::Integer& i) const { return i.hash(); }
};
}  // namespace std

#endif /* AVA6__UTIL__INTEGER_GMP_H */
