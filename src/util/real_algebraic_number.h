...
#ifndef AVA6__REAL_ALGEBRAIC_NUMBER_H
#define AVA6__REAL_ALGEBRAIC_NUMBER_H
...
namespace std {
template <>
struct hash<ava6::internal::RealAlgebraicNumber>
{
  /**
   ...
   * approximation.
   */
  size_t operator()(const ava6::internal::RealAlgebraicNumber& ran) const;
};
}  // namespace std

#endif /* AVA6__REAL_ALGEBRAIC_NUMBER_H */
