...
template <size_t N>
void AVA6_EXPORT safe_print(int fd, const char (&msg)[N]);
template <typename T>
void AVA6_EXPORT safe_print(int fd, const T& obj);
...
template <>
void AVA6_EXPORT safe_print(int fd, const std::string& msg);
template <>
void AVA6_EXPORT safe_print(int fd, const int64_t& _i);
template <>
void AVA6_EXPORT safe_print(int fd, const int32_t& i);
template <>
void AVA6_EXPORT safe_print(int fd, const uint64_t& _i);
template <>
void AVA6_EXPORT safe_print(int fd, const uint32_t& i);
template <>
void AVA6_EXPORT safe_print(int fd, const double& _d);
template <>
void AVA6_EXPORT safe_print(int fd, const float& f);
template <>
void AVA6_EXPORT safe_print(int fd, const bool& b);
template <>
void AVA6_EXPORT safe_print(int fd, void* const& addr);
template <>
void AVA6_EXPORT safe_print(int fd, const timespec& t);
