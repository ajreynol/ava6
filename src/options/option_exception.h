...
#ifndef AVA6__OPTION_EXCEPTION_H
#define AVA6__OPTION_EXCEPTION_H
 ...
 */
class AVA6_EXPORT OptionException : public ava6::internal::Exception
{
 public:
  OptionException(const std::string& s)
      : ava6::internal::Exception(s_errPrefix + s)
  {
  }
 ...
 */
class AVA6_EXPORT FatalOptionException : public ava6::internal::Exception
{
 public:
...
#endif /* AVA6__OPTION_EXCEPTION_H */
