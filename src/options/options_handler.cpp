...
void OptionsHandler::setErrStream(AVA6_UNUSED const std::string& flag,
...
void OptionsHandler::setVerbosity(AVA6_UNUSED const std::string& flag,
...
void OptionsHandler::decreaseVerbosity(AVA6_UNUSED const std::string& flag,
                                       AVA6_UNUSED bool value)
{
  d_options->write_base().verbosity -= 1;
  setVerbosity(flag, d_options->base.verbosity);
}

void OptionsHandler::increaseVerbosity(AVA6_UNUSED const std::string& flag,
                                       AVA6_UNUSED bool value)
{
  d_options->write_base().verbosity += 1;
  setVerbosity(flag, d_options->base.verbosity);
...
void OptionsHandler::setStats(AVA6_UNUSED const std::string& flag,
                              const bool value) const
{
#ifndef AVA6_STATISTICS_ON
  if (value)
  {
    std::stringstream ss;
    ss << "option `" << flag
       << "' requires a statistics-enabled build of ava6; this binary was not "
          "built with statistics support";
    throw OptionException(ss.str());
  }
#endif /* AVA6_STATISTICS_ON */
  if (!value)
  {
...
void OptionsHandler::setStatsDetail(AVA6_UNUSED const std::string& flag,
                                    const bool value) const
{
#ifndef AVA6_STATISTICS_ON
  if (value)
...
void OptionsHandler::enableTraceTag(AVA6_UNUSED const std::string& flag,
                                    const std::string& optarg) const
{
...
void OptionsHandler::enableOutputTag(AVA6_UNUSED const std::string& flag,
...
void OptionsHandler::setResourceWeight(AVA6_UNUSED const std::string& flag,
                                       const std::string& optarg) const
{
...
void OptionsHandler::showConfiguration(AVA6_UNUSED const std::string& flag,
                                       const bool value) const
{
  if (!value) return;
