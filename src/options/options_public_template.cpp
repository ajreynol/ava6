...
template <typename T>
T handleOption(AVA6_UNUSED const std::string& flag,
               AVA6_UNUSED const std::string& optionarg)
{
...
template <>
std::string handleOption<std::string>(AVA6_UNUSED const std::string& flag,
                                      const std::string& optionarg)
{
  return optionarg;
}
...
template <>
ManagedIn handleOption<ManagedIn>(AVA6_UNUSED const std::string& flag,
                                  const std::string& optionarg)
{
  ManagedIn res;
  res.open(optionarg);
...
template <>
ManagedErr handleOption<ManagedErr>(AVA6_UNUSED const std::string& flag,
                                    const std::string& optionarg)
{
  ManagedErr res;
  res.open(optionarg);
...
template <>
ManagedOut handleOption<ManagedOut>(AVA6_UNUSED const std::string& flag,
                                    const std::string& optionarg)
{
  ManagedOut res;
  res.open(optionarg);
