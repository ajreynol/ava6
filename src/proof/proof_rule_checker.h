...
#ifndef AVA6__PROOF__PROOF_RULE_CHECKER_H
#define AVA6__PROOF__PROOF_RULE_CHECKER_H
...
class ProofRuleChecker
{
 public:
  ...
  virtual void registerTo(AVA6_UNUSED ProofChecker* pc) {}
...
#endif /* AVA6__PROOF__PROOF_RULE_CHECKER_H */
