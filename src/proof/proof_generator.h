...
#ifndef AVA6__PROOF__PROOF_GENERATOR_H
#define AVA6__PROOF__PROOF_GENERATOR_H
...
class ProofGenerator
{
 public:
   ...
   */
  virtual bool hasProofFor(AVA6_UNUSED Node f) { return true; }
...
#endif /* AVA6__PROOF__PROOF_GENERATOR_H */
