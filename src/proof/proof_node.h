...
#ifndef AVA6__PROOF__PROOF_NODE_H
#define AVA6__PROOF__PROOF_NODE_H
 ...
 *
 * However, the rest of ava6 sees only the *Skolem* form of arguments and
 * conclusions in ProofNode, since this is what is used throughout ava6.
 */
class ProofNode
{
...
namespace std {
template <>
struct hash<ava6::internal::ProofNode>
{
  size_t operator()(const ava6::internal::ProofNode& node) const;
};
}  // namespace std
...
#endif /* AVA6__PROOF__PROOF_NODE_H */
