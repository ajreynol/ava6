...
#ifndef AVA6__PROOF__VALID_WITNESS_PROOF_GENERATOR_H
#define AVA6__PROOF__VALID_WITNESS_PROOF_GENERATOR_H
...
#endif /* AVA6__PROOF__VALID_WITNESS_PROOF_GENERATOR_H */
