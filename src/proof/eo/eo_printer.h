...
#ifndef AVA6__PROOF__EO_PROOF_PRINTER_H
#define AVA6__PROOF__EO_PROOF_PRINTER_H
...
class EoPrinter : protected EnvObj
{
 ...
 private:
  ...
  static bool isHandledTheoryRewrite(ProofRewriteRule id,
                                     const Node& n);
...
#endif /* AVA6__PROOF__EO_PROOF_PRINTER_H */
