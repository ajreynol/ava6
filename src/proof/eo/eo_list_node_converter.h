...
#ifndef AVA6__PROOF__EO__EO_LIST_NODE_CONVERTER_H
#define AVA6__PROOF__EO__EO_LIST_NODE_CONVERTER_H
 ...
 * in their internal ava6+RARE representation. In particular,
