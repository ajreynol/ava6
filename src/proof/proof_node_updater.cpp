...
bool ProofNodeUpdaterCallback::shouldUpdate(
    AVA6_UNUSED std::shared_ptr<ProofNode> pn,
    AVA6_UNUSED const std::vector<Node>& fa,
    AVA6_UNUSED bool& continueUpdate)
{
  return false;
}

bool ProofNodeUpdaterCallback::update(
    AVA6_UNUSED Node res,
    AVA6_UNUSED ProofRule id,
    AVA6_UNUSED const std::vector<Node>& children,
    AVA6_UNUSED const std::vector<Node>& args,
    AVA6_UNUSED CDProof* cdp,
    AVA6_UNUSED bool& continueUpdate)
{
  return false;
}
