 ...
 * ****************************************************************************
 *
 * ava6's exception base class and some associated utilities.
 */

#include "ava6_public.h"

#ifndef AVA6__EXCEPTION_H
#define AVA6__EXCEPTION_H
...
class AVA6_EXPORT Exception : public std::exception
{
 protected:
  std::string d_msg;
...
class AVA6_EXPORT IllegalArgumentException : public Exception
{
 protected:
...
inline void CheckArgument(bool cond,
                          const T& arg AVA6_UNUSED,
                          const char* tail AVA6_UNUSED)
{
  if (__builtin_expect((!cond), false))
  {
    throw ava6::internal::IllegalArgumentException("", "", tail);
  }
}
template <class T>
inline void CheckArgument(bool cond, const T& arg);
template <class T>
inline void CheckArgument(bool cond, const T& arg AVA6_UNUSED)
{
  if (__builtin_expect((!cond), false))
  {
