 ...
 *
 * This file is the implementation for the ava6 interactive shell.
      ...
      d_quit(false)
{
  ...
  d_parser.reset(
      new ava6::parser::InputParser(d_solver, cexec->getSymbolManager()));
  ...
  {
    ::rl_readline_name = const_cast<char*>("ava6");
    ...
    if (d_lang == modes::InputLanguage::SMT_LIB_2_6)
    {
      ...
      if (home != nullptr)
      {
        d_historyFilename = string(home) + "/.ava6_history_smtlib2";
...
restart:
  ...
  catch (ParserException& pe)
  {
    ...
    // in the symbol table.  So unfortunately, either we exit ava6 entirely,
