...
#ifndef AVA6__PREPROCESSING__PASSES__DISTINCT_ELIM_H
#define AVA6__PREPROCESSING__PASSES__DISTINCT_ELIM_H
...
#endif /* AVA6__PREPROCESSING__PASSES__DISTINCT_ELIM_H */
