...
#ifndef AVA6__PREPROCESSING__PASSES__NL_EXT_PURIFY_H
#define AVA6__PREPROCESSING__PASSES__NL_EXT_PURIFY_H
...
#endif /* AVA6__PREPROCESSING__PASSES__NL_EXT_PURIFY_H */
