...
#ifndef AVA6__PREPROCESSING__PASSES__FUN_DEF_FMF_H
#define AVA6__PREPROCESSING__PASSES__FUN_DEF_FMF_H
...
#endif /* AVA6__PREPROCESSING__PASSES__SYGUS_INFERENCE_H_ */
