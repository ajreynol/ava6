...
#ifndef __AVA6__PREPROCESSING__PASSES__HO_ELIM_PASS_H
#define __AVA6__PREPROCESSING__PASSES__HO_ELIM_PASS_H
...
#endif /* __AVA6__PREPROCESSING__PASSES__HO_ELIM_PASS_H */
