...
#ifndef AVA6__PREPROCESSING__PASSES__GLOBAL_NEGATE_H
#define AVA6__PREPROCESSING__PASSES__GLOBAL_NEGATE_H
...
#endif /* AVA6__PREPROCESSING_PASSES__GLOBAL_NEGATE_H */
