...
#ifndef AVA6__PREPROCESSING__PASSES__SORT_INFERENCE_PASS_H_
#define AVA6__PREPROCESSING__PASSES__SORT_INFERENCE_PASS_H_
...
#endif /* AVA6__PREPROCESSING__PASSES__SORT_INFERENCE_PASS_H_ */
