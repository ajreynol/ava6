...
#ifndef AVA6__PREPROCESSING__PASSES__STATIC_REWRITE_H
#define AVA6__PREPROCESSING__PASSES__STATIC_REWRITE_H
...
#endif /* AVA6__PREPROCESSING__PASSES__STATIC_PP_REWRITE_H */
