...
#ifndef AVA6__PREPROCESSING__PASSES__EXTENDED_REWRITER_PASS_H
#define AVA6__PREPROCESSING__PASSES__EXTENDED_REWRITER_PASS_H
...
#endif /* AVA6__PREPROCESSING__PASSES__EXTENDED_REWRITER_PASS_H */
