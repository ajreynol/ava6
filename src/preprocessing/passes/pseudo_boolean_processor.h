...
#ifndef AVA6__PREPROCESSING__PASSES__PSEUDO_BOOLEAN_PROCESSOR_H
#define AVA6__PREPROCESSING__PASSES__PSEUDO_BOOLEAN_PROCESSOR_H
...
#endif  // AVA6__PREPROCESSING__PASSES__PSEUDO_BOOLEAN_PROCESSOR_H
