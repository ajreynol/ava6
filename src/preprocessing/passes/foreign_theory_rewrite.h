...
#ifndef AVA6__PREPROCESSING__PASSES__FOREIGN_THEORY_REWRITE_H
#define AVA6__PREPROCESSING__PASSES__FOREIGN_THEORY_REWRITE_H
...
#endif /* AVA6__PREPROCESSING__PASSES__FOREIGN_THEORY_REWRITE_H */
