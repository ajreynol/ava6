...
#ifndef AVA6__BOOLEAN_SIMPLIFICATION_H
#define AVA6__BOOLEAN_SIMPLIFICATION_H
...
class BooleanSimplification
{
  ...
  AVA6_WARN_UNUSED_RESULT static bool push_back_associative_commute_recursive(
...
#endif /* AVA6__BOOLEAN_SIMPLIFICATION_H */
