...
#ifndef AVA6__NODE_MANAGER_H
#define AVA6__NODE_MANAGER_H
...
class NodeManager
{
 ...
 public:
   ...
   * n.getConst<ava6::internal::Kind>() will yield k.
   */
 ...
 private:
   ...
   *          within ava6. Instead, the SkolemManager submodule is the
   ...
   * plusOperator->getConst<ava6::internal::Kind>(), you get Kind::ADD back.
   */
