...
#ifndef AVA6__EXPR__SEQUENCE_H
#define AVA6__EXPR__SEQUENCE_H
...
class Sequence
{
 public:
   ...
   *
   * Internally, a ava6::internal::Sequence is represented by a vector of Nodes
