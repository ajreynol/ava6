...
size_t hash<ava6::internal::Node>::operator()(
    const ava6::internal::Node& node) const
{
  return node.getId();
}

size_t hash<ava6::internal::TNode>::operator()(
    const ava6::internal::TNode& node) const
{
  return node.getId();
}
