...
#ifndef AVA6__EXPR__DTYPE_SELECTOR_H
#define AVA6__EXPR__DTYPE_SELECTOR_H
 ...
 */
template <>
struct hash<ava6::internal::DTypeSelector>
{
  size_t operator()(const ava6::internal::DTypeSelector& cons) const;
};
}  // namespace std
#endif
