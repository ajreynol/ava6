 ...
 * Instances of this class are generally referenced through ava6::internal::Node
 * rather than by pointer. Note that ava6::internal::Node maintains the
 * reference count on NodeValue instances.
 */

#include "ava6_private.h"

#ifndef AVA6__EXPR__NODE_VALUE_H
#define AVA6__EXPR__NODE_VALUE_H
...
template <ava6::internal::Kind k, class T, bool pool>
 ...
 * This is a NodeValue.
 */
class AVA6_EXPORT NodeValue
{
  template <bool>
  friend class ava6::internal::NodeTemplate;
  friend class ava6::internal::TypeNode;
  friend class ava6::internal::NodeBuilder;
  friend class ava6::internal::NodeManager;
...
#endif /* AVA6__EXPR__NODE_VALUE_H */
