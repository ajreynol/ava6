 ...
 *
 * More guidelines on when to use TNodes is available in the ava6
 * Developer's Guide:
...
template <>
struct hash<ava6::internal::Node>
{
  size_t operator()(const ava6::internal::Node& node) const;
};

template <>
struct hash<ava6::internal::TNode>
{
  size_t operator()(const ava6::internal::TNode& node) const;
};
...
class NodeTemplate
{
  ...
  friend class ::ava6::internal::expr::attr::AttributeManager;
  friend struct ::ava6::internal::expr::attr::SmtAttributes;
 ...
 public:
   ...
   */
  template <class T>
  AVA6_NO_DANGLING inline const T& getConst() const;
