...
#ifndef AVA6__NODE_BUILDER_H
#define AVA6__NODE_BUILDER_H
...
class NodeBuilder
{
 ...
 private:
  ...
  inline void maybeCheckType(AVA6_UNUSED const TNode n) const {}
#endif /* AVA6_DEBUG */
   ...
   */
  AVA6_UNUSED_FIELD expr::NodeValue*
