...
#ifndef AVA6__TYPE_NODE_H
#define AVA6__TYPE_NODE_H
...
class AVA6_EXPORT TypeNode
{
 ...
 public:
   ...
   * that are fully handled by ava6's quantifier-free theory solvers. Examples
  ...
  AVA6_NO_DANGLING const DType& getDType() const;
...
template <>
struct hash<ava6::internal::TypeNode>
{
  size_t operator()(const ava6::internal::TypeNode& tn) const;
};
