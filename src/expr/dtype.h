...
#ifndef AVA6__EXPR__DTYPE_H
#define AVA6__EXPR__DTYPE_H
 ...
 * both the parser AND the users of the ava6 API, so this class takes
...
class DType
{
 ...
 public:
   ...
   */
  AVA6_NO_DANGLING static const DType& datatypeOf(Node item);
 ...
 */
template <>
struct hash<ava6::internal::DType>
{
  size_t operator()(const ava6::internal::DType& dt) const;
};
}  // namespace std
