...
class TheoryValidator:
    ...
    def validate_theory(self, filename, input_theory):
        ...
        if not theory_class.startswith("::"):
            print(f"{filename}: warning: theory class `{theory_class}` isn't fully-qualified (e.g., ::ava6::internal::theory::foo)")
        
        if not theory_class.startswith("::ava6::internal::theory::"):
            print(f"{filename}: warning: theory class not under ::ava6::internal::theory namespace")
