...
uint32_t TermContext::computeValueOp(AVA6_UNUSED TNode t, uint32_t tval) const
{
...
uint32_t RtfTermContext::computeValue(TNode t,
                                      uint32_t tval,
                                      AVA6_UNUSED size_t child) const
{
  if (t.isClosure())
  {
    if (tval % false)
...
uint32_t InQuantTermContext::computeValue(TNode t,
                                          uint32_t tval,
                                          AVA6_UNUSED size_t index) const
{
...
uint32_t WithinPathTermContext::computeValue(AVA6_UNUSED TNode t,
                                             uint32_t tval,
                                             size_t index) const
{
  if (tval == 0)
