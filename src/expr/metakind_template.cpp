...
{
  static bool compare(const ava6::internal::expr::NodeValue* x,
                      const ava6::internal::expr::NodeValue* y)
  {
    if (pool)
    {
      if (x->d_nchildren == 1)
...
size_t NodeValueCompare::constHash(const ava6::internal::expr::NodeValue* nv)
{
  ...
  switch (static_cast<Kind>(nv->d_kind))
  {
    ...
    ${metakind_constHashes}
      // clang-format on
    default:
      Unhandled() << ava6::internal::expr::NodeValue::dKindToKind(nv->d_kind);
  }
}

template <bool pool>
bool NodeValueCompare::compare(const ava6::internal::expr::NodeValue* nv1,
...
${metakind_compares}
      // clang-format on
      default:
        Unhandled() << ava6::internal::expr::NodeValue::dKindToKind(
            nv1->d_kind);
    }
  }
  ...
  ava6::internal::expr::NodeValue::const_nv_iterator i = nv1->nv_begin();
  ava6::internal::expr::NodeValue::const_nv_iterator j = nv2->nv_begin();
  ava6::internal::expr::NodeValue::const_nv_iterator i_end = nv1->nv_end();
...
template bool NodeValueCompare::compare<true>(
    const ava6::internal::expr::NodeValue* nv1,
    const ava6::internal::expr::NodeValue* nv2);
...
Kind operatorToKind(ava6::internal::expr::NodeValue* nv)
{
  ...
  switch (Kind k AVA6_UNUSED = nv->getKind())
  {
    // clang-format off
