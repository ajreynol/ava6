...
#ifndef AVA6__EXPR__ATTRIBUTE_H
#define AVA6__EXPR__ATTRIBUTE_H
...
#define AVA6_ATTRIBUTE_H__INCLUDING__ATTRIBUTE_INTERNALS_H
#include "expr/attribute_internals.h"
#undef AVA6_ATTRIBUTE_H__INCLUDING__ATTRIBUTE_INTERNALS_H
...
class AttributeManager
{
 ...
 public:
   ...
   * the AttributeManager without recompiling all of ava6.
...
struct HasAttribute<true, AttrKind>
{
  ...
  static inline bool hasAttribute(AVA6_UNUSED const AttributeManager* am,
                                  AVA6_UNUSED NodeValue* nv)
  {
    return true;
  }
