...
std::ostream& operator<<(std::ostream& out, ava6::internal::Kind k)
{
...
std::string kindToString(ava6::internal::Kind k) { return toString(k); }
...
TheoryId kindToTheoryId(ava6::internal::Kind k)
{
  switch (k)
  {
...
TheoryId typeConstantToTheoryId(ava6::internal::TypeConstant typeConstant)
{
  switch (typeConstant)
  {
    // clang-format off
