...
#ifndef AVA6__EXPR__SYGUS_GRAMMAR_H
#define AVA6__EXPR__SYGUS_GRAMMAR_H
...
namespace std {
template <>
struct hash<ava6::internal::SygusGrammar>
{
  size_t operator()(const ava6::internal::SygusGrammar& grammar) const;
};
}  // namespace std
#endif
