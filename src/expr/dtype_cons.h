...
#ifndef AVA6__EXPR__DTYPE_CONS_H
#define AVA6__EXPR__DTYPE_CONS_H
 ...
 */
template <>
struct hash<ava6::internal::DTypeConstructor>
{
  size_t operator()(const ava6::internal::DTypeConstructor& cons) const;
};
}  // namespace std
#endif
