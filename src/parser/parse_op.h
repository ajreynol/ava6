...
#ifndef AVA6__PARSER__PARSE_OP_H
#define AVA6__PARSER__PARSE_OP_H
...
struct ParseOp
{
  ParseOp(ava6::Kind k = ava6::Kind::NULL_TERM) : d_kind(k) {}
  ...
  ava6::Term d_expr;
  /**
   * The indices if the operator is indexed, but ava6::Op is the null operator.
...
#endif /* AVA6__PARSER__PARSE_OP_H */
