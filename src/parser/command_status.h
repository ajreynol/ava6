...
#ifndef AVA6__PARSER__COMMAND_STATUS_H
#define AVA6__PARSER__COMMAND_STATUS_H
...
std::ostream& operator<<(std::ostream&, const CommandStatus&) AVA6_EXPORT;
std::ostream& operator<<(std::ostream&, const CommandStatus*) AVA6_EXPORT;

class AVA6_EXPORT CommandStatus
{
 protected:
...
class AVA6_EXPORT CommandSuccess : public CommandStatus
{
...
class AVA6_EXPORT CommandInterrupted : public CommandStatus
{
...
class AVA6_EXPORT CommandUnsupported : public CommandStatus
{
 public:
  void toStream(std::ostream& out) const override;
  CommandStatus& clone() const override
...
class AVA6_EXPORT CommandFailure : public CommandStatus
{
 public:
 ...
 */
class AVA6_EXPORT CommandRecoverableFailure : public CommandStatus
{
  std::string d_message;
