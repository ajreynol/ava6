...
#ifndef AVA6__SYMBOL_TABLE_H
#define AVA6__SYMBOL_TABLE_H
...
namespace ava6::internal::parser {

class AVA6_EXPORT ScopeException : public internal::Exception
{
};
...
class AVA6_EXPORT SymbolTable
{
 public:
   ...
   */
  bool bind(const std::string& name, ava6::Term obj, bool doOverload = false);
   ...
   * Returns false if the binding was invalid.
   */
  bool bindDummySortTerm(const std::string& name, ava6::Term t);
   ...
   * @returns true iff name is successfully bound to t.
   */
  void bindType(const std::string& name, ava6::Sort t);
   ...
   */
  ava6::Term lookup(const std::string& name) const;
   ...
   */
  ava6::Sort lookupType(const std::string& name) const;
   ...
   * the current scope.
   */
  ava6::Sort lookupType(const std::string& name,
                        const std::vector<ava6::Sort>& params) const;
  ...
  bool isOverloadedFunction(ava6::Term fun) const;

  /** Get overloaded constant for type.
   * If possible, it returns the defined symbol with name
   * that has type t. Otherwise returns null expression.
   */
  ava6::Term getOverloadedConstantForType(const std::string& name,
                                          ava6::Sort t) const;
   ...
   */
  ava6::Term getOverloadedFunctionForTypes(
      const std::string& name, const std::vector<ava6::Sort>& argTypes) const;
