...
#ifndef AVA6__PARSER__PARSER_STATE_H
#define AVA6__PARSER__PARSER_STATE_H
...
class AVA6_EXPORT ParserState
{
 public:
  ...
  /** Create a new ava6 variable expression of the given type.
   *
  ...
  /**
   * Create a (possibly) new ava6 bound variable expression of the given type.
  ...
  Term bindBoundVar(const std::string& name,
                    ...
                    bool fresh = true);
  /**
   * Create new ava6 bound variable expressions of the given names and types.
  ...
  /**
   * Create a set of new ava6 bound variable expressions of the given type.
   *
...
#endif /* AVA6__PARSER__PARSER_STATE_H */
