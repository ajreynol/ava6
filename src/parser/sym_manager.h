...
#ifndef AVA6__PARSER__SYM_MANAGER_H
#define AVA6__PARSER__SYM_MANAGER_H
 ...
 */
class AVA6_EXPORT SymManager
{
  friend class ava6::parser::Command;

 public:
  SymManager(ava6::TermManager& tm);
  ~SymManager();
  /** Get the underlying symbol table */
  ava6::internal::parser::SymbolTable* getSymbolTable();
   ...
   * @return false if the binding was invalid.
   */
  bool bindType(const std::string& name, ava6::Sort t, bool isUser);
   ...
   */
  bool bindMutualDatatypeTypes(const std::vector<ava6::Sort>& datatypes,
...
#endif /* AVA6__PARSER__SYM_MANAGER_H */
