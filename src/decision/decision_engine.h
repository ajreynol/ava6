...
#ifndef AVA6__DECISION__DECISION_ENGINE_H
#define AVA6__DECISION__DECISION_ENGINE_H
...
class DecisionEngine : protected EnvObj
{
 public:
   ...
   * @param lems The lemmas to add.
   */
  virtual void addLocalAssertions(AVA6_UNUSED const std::vector<TNode>& lems) {}
...
#endif /* AVA6__DECISION__DECISION_ENGINE_H */
