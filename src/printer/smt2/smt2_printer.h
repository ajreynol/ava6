...
#ifndef AVA6__PRINTER__SMT2_PRINTER_H
#define AVA6__PRINTER__SMT2_PRINTER_H
...
class Smt2Printer : public ava6::internal::Printer
{
 public:
  Smt2Printer(Variant variant = Variant::no_variant) : d_variant(variant) {}
  using ava6::internal::Printer::toStream;
...
#endif /* AVA6__PRINTER__SMT2_PRINTER_H */
