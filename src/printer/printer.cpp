...
void Printer::toStreamCmdDefineType(
    std::ostream& out,
    AVA6_UNUSED const std::string& id,
    AVA6_UNUSED const std::vector<TypeNode>& params,
    AVA6_UNUSED TypeNode t) const
{
...
void Printer::toStreamCmdDefineFunction(
    std::ostream& out,
    AVA6_UNUSED const std::string& id,
    AVA6_UNUSED const std::vector<Node>& formals,
    AVA6_UNUSED TypeNode range,
    AVA6_UNUSED Node formula) const
{
...
void Printer::toStreamCmdDefineFunctionRec(
    std::ostream& out,
    AVA6_UNUSED const std::vector<Node>& funcs,
    AVA6_UNUSED const std::vector<std::vector<Node>>& formals,
    AVA6_UNUSED const std::vector<Node>& formulas) const
{
...
void Printer::toStreamCmdSetUserAttribute(std::ostream& out,
                                          AVA6_UNUSED const std::string& attr,
                                          AVA6_UNUSED Node n) const
{
...
void Printer::toStreamCmdQuery(std::ostream& out, AVA6_UNUSED Node n) const
{
...
void Printer::toStreamCmdSetBenchmarkLogic(
    std::ostream& out, AVA6_UNUSED const std::string& logic) const
{
  printUnknownCommand(out, "set-logic");
}

void Printer::toStreamCmdSetInfo(std::ostream& out,
                                 AVA6_UNUSED const std::string& flag,
                                 AVA6_UNUSED const std::string& value) const
{
  printUnknownCommand(out, "set-info");
}

void Printer::toStreamCmdGetInfo(std::ostream& out,
                                 AVA6_UNUSED const std::string& flag) const
{
...
void Printer::toStreamCmdDeclareHeap(std::ostream& out,
                                     AVA6_UNUSED TypeNode locType,
                                     AVA6_UNUSED TypeNode dataType) const
{
