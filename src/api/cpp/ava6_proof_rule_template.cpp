...
const char* toString(ava6::ProofRewriteRule rule)
{
  switch (rule)
  {
...
size_t hash<ava6::ProofRule>::operator()(ava6::ProofRule rule) const
{
  return static_cast<size_t>(rule);
}

std::string to_string(ava6::ProofRule rule) { return ava6::toString(rule); }

size_t hash<ava6::ProofRewriteRule>::operator()(
    ava6::ProofRewriteRule rule) const
{
  return static_cast<size_t>(rule);
}

std::string to_string(ava6::ProofRewriteRule rule)
{
  return ava6::toString(rule);
}
