...
#ifndef AVA6__REWRITER__REWRITE_DB_TERM_PROCESS__H
#define AVA6__REWRITER__REWRITE_DB_TERM_PROCESS__H
 ...
 * different than the default representation of terms in ava6. These
 * differences include:
 * (1) ava6 has (word) string literals; the DSL assumes these are
...
#endif /* AVA6__THEORY__REWRITE_DB_TERM_PROCESS__H */
